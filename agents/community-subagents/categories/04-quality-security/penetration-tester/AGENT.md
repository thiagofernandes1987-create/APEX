---
agent_id: subagent.04-quality-security.penetration_tester
name: "penetration-tester"
description: "Use this agent when you need to conduct authorized security penetration tests to identify real vulnerabilities through active exploitation and validation. Use penetration-tester for offensive security"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\04-quality-security\penetration-tester.md"
capabilities:
  - penetration tester
  - quality-security
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: penetration-tester].
