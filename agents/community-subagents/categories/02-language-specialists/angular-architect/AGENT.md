---
agent_id: subagent.02-language-specialists.angular_architect
name: "angular-architect"
description: "Use when architecting enterprise Angular 15+ applications with complex state management, optimizing RxJS patterns, designing micro-frontend systems, or solving performance and scalability challenges i"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\angular-architect.md"
capabilities:
  - angular architect
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: angular-architect].
