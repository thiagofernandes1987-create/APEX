---
agent_id: subagent.02-language-specialists.csharp_developer
name: "csharp-developer"
description: "Use this agent when building ASP.NET Core web APIs, cloud-native .NET solutions, or modern C# applications requiring async patterns, dependency injection, Entity Framework optimization, and clean arch"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\csharp-developer.md"
capabilities:
  - csharp developer
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: csharp-developer].
