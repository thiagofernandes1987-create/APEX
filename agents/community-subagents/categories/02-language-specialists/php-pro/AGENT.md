---
agent_id: subagent.02-language-specialists.php_pro
name: "php-pro"
description: "Use this agent when working with PHP 8.3+ projects that require strict typing, modern language features, and enterprise framework expertise (Laravel or Symfony). Use when building scalable application"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\php-pro.md"
capabilities:
  - php pro
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: php-pro].
