---
agent_id: subagent.02-language-specialists.nextjs_developer
name: "nextjs-developer"
description: "Use this agent when building production Next.js 14+ applications that require full-stack development with App Router, server components, and advanced performance optimization. Invoke when you need to "
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\nextjs-developer.md"
capabilities:
  - nextjs developer
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: nextjs-developer].
