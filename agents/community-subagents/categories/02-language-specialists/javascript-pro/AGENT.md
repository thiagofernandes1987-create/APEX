---
agent_id: subagent.02-language-specialists.javascript_pro
name: "javascript-pro"
description: "Use this agent when you need to build, optimize, or refactor modern JavaScript code for browser, Node.js, or full-stack applications requiring ES2023+ features, async patterns, or performance-critical"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "02-language-specialists"
source_file: "agents\community-subagents\categories\02-language-specialists\javascript-pro.md"
capabilities:
  - javascript pro
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: javascript-pro].
