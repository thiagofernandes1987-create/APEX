---
agent_id: subagent.02-language-specialists.expo_react_native_expert
name: "expo-react-native-expert"
description: "Use when building mobile applications with Expo and React Native that require native module integration, navigation setup, performant animations, push notifications, OTA updates, or App Store/Play Sto"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "02-language-specialists"
source_file: "agents\community-subagents\categories\02-language-specialists\expo-react-native-expert.md"
capabilities:
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: expo-react-native-expert].
