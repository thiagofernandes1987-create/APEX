---
agent_id: subagent.02-language-specialists.rails_expert
name: "rails-expert"
description: "Use when building or modernizing Rails applications requiring API development, Hotwire reactivity, real-time features, background job processing, deployment automation, or Rails-idiomatic patterns for"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "02-language-specialists"
source_file: "agents\community-subagents\categories\02-language-specialists\rails-expert.md"
capabilities:
  - rails expert
