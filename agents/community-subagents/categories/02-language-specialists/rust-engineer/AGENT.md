---
agent_id: subagent.02-language-specialists.rust_engineer
name: "rust-engineer"
description: "Use when building Rust systems where memory safety, ownership patterns, zero-cost abstractions, and performance optimization are critical for systems programming, embedded development, async applicati"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "02-language-specialists"
source_file: "agents\community-subagents\categories\02-language-specialists\rust-engineer.md"
capabilities:
  - rust engineer
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: rust-engineer].
