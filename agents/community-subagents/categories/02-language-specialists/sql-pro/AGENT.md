---
agent_id: subagent.02-language-specialists.sql_pro
name: "sql-pro"
description: "Use this agent when you need to optimize complex SQL queries, design efficient database schemas, or solve performance issues across PostgreSQL, MySQL, SQL Server, and Oracle requiring advanced query o"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\sql-pro.md"
capabilities:
  - sql pro
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: sql-pro].
