---
agent_id: subagent.02-language-specialists.dotnet_core_expert
name: "dotnet-core-expert"
description: "Use when building .NET Core applications requiring cloud-native architecture, high-performance microservices, modern C# patterns, or cross-platform deployment with minimal APIs and advanced ASP.NET Co"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\dotnet-core-expert.md"
capabilities:
  - dotnet core expert
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: dotnet-core-expert].
