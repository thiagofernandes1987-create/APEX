---
agent_id: subagent.02-language-specialists.flutter_expert
name: "flutter-expert"
description: "Use when building cross-platform mobile applications with Flutter 3+ that require custom UI implementation, complex state management, native platform integrations, or performance optimization across i"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\02-language-specialists\flutter-expert.md"
capabilities:
  - flutter expert
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: flutter-expert].
