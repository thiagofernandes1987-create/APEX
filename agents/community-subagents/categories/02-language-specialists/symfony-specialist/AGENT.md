---
agent_id: subagent.02-language-specialists.symfony_specialist
name: "symfony-specialist"
description: "Use when building Symfony 6+/7+/8+ applications, architecting Doctrine ORM entities with complex relationships, implementing Messenger component for async processing, or optimizing API Platform perfor"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "02-language-specialists"
source_file: "agents\community-subagents\categories\02-language-specialists\symfony-specialist.md"
capabilities:
  - symfony specialist
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: symfony-specialist].
