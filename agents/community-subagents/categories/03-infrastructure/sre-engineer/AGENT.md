---
agent_id: subagent.03-infrastructure.sre_engineer
name: "sre-engineer"
description: "Use this agent when you need to establish or improve system reliability through SLO definition, error budget management, and automation. Invoke when implementing SLI/SLO frameworks, reducing operation"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "03-infrastructure"
source_file: "agents\community-subagents\categories\03-infrastructure\sre-engineer.md"
capabilities:
  - sre engineer
  - infrastructure
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: sre-engineer].
