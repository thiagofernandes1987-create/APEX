---
agent_id: subagent.03-infrastructure.platform_engineer
name: "platform-engineer"
description: "Use when building or improving internal developer platforms (IDPs), designing self-service infrastructure, or optimizing developer workflows to reduce friction and accelerate delivery. The platform-en"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\03-infrastructure\platform-engineer.md"
capabilities:
  - platform engineer
  - infrastructure
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: platform-engineer].
