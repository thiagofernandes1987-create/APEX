---
agent_id: subagent.03-infrastructure.devops_engineer
name: "devops-engineer"
description: "Use this agent when building or optimizing infrastructure automation, CI/CD pipelines, containerization strategies, and deployment workflows to accelerate software delivery while maintaining reliabili"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\03-infrastructure\devops-engineer.md"
capabilities:
  - devops engineer
  - infrastructure
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: devops-engineer].
