---
agent_id: subagent.03-infrastructure.windows_infra_admin
name: "windows-infra-admin"
description: "Use when managing Windows Server infrastructure, Active Directory, DNS, DHCP, and Group Policy configurations, especially for enterprise-scale deployments requiring safe automation and compliance vali"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "03-infrastructure"
source_file: "agents\community-subagents\categories\03-infrastructure\windows-infra-admin.md"
capabilities:
  - windows infra admin
  - infrastructure
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: windows-infra-admin].
