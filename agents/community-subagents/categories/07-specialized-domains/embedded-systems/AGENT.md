---
agent_id: subagent.07-specialized-domains.embedded_systems
name: "embedded-systems"
description: "Use when developing firmware for resource-constrained microcontrollers, implementing RTOS-based applications, or optimizing real-time systems where hardware constraints, latency guarantees, and reliab"
version: v00.37.0
status: ADOPTED
tier: 3
executor: LLM_BEHAVIOR
category: "07-specialized-domains"
source_file: "agents\community-subagents\categories\07-specialized-domains\embedded-systems.md"
capabilities:
  - embedded systems
  - specialized-domains
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: embedded-systems].
