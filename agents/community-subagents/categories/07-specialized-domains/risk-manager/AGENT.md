---
agent_id: subagent.07-specialized-domains.risk_manager
name: "risk-manager"
description: "Use this agent when you need to identify, quantify, and mitigate enterprise-level risks across financial, operational, regulatory, and strategic domains. Invoke this agent when you need to assess risk"
version: v00.37.0
status: ADOPTED
tier: 3
...
source_file: "agents\community-subagents\categories\07-specialized-domains\risk-manager.md"
capabilities:
  - risk manager
  - specialized-domains
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: risk-manager].
