---
agent_id: subagent.07-specialized-domains.quant_analyst
name: "quant-analyst"
description: "Use this agent when you need to develop quantitative trading strategies, build financial models with rigorous mathematical foundations, or conduct advanced risk analytics for derivatives and portfolio"
version: v00.37.0
status: ADOPTED
tier: 3
executor: LLM_BEHAVIOR
category: "07-specialized-domains"
source_file: "agents\community-subagents\categories\07-specialized-domains\quant-analyst.md"
capabilities:
  - quant analyst
  - specialized-domains
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: quant-analyst].
