---
agent_id: subagent.05-data-ai.mlops_engineer
name: "mlops-engineer"
description: "Use this agent when you need to design and implement ML infrastructure, set up CI/CD for machine learning models, establish model versioning systems, or optimize ML platforms for reliability and autom"
version: v00.37.0
status: ADOPTED
tier: 2
...
primary_domain: data
category: "05-data-ai"
source_file: "agents\community-subagents\categories\05-data-ai\mlops-engineer.md"
capabilities:
  - mlops engineer
  - data-ai
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: mlops-engineer].
