---
agent_id: subagent.05-data-ai.postgres_pro
name: "postgres-pro"
description: "Use when you need to optimize PostgreSQL performance, design high-availability replication, or troubleshoot database issues at scale. Invoke this agent for query optimization, configuration tuning, re"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "05-data-ai"
source_file: "agents\community-subagents\categories\05-data-ai\postgres-pro.md"
capabilities:
  - postgres pro
  - data-ai
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: postgres-pro].
