---
agent_id: subagent.05-data-ai.nlp_engineer
name: "nlp-engineer"
description: "Use when building production NLP systems, implementing text processing pipelines, developing language models, or solving domain-specific NLP tasks like named entity recognition, sentiment analysis, or"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "05-data-ai"
source_file: "agents\community-subagents\categories\05-data-ai\nlp-engineer.md"
capabilities:
  - nlp engineer
  - data-ai
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: nlp-engineer].
