---
agent_id: subagent.05-data-ai.data_scientist
name: "data-scientist"
description: "Use this agent when you need to analyze data patterns, build predictive models, or extract statistical insights from datasets. Invoke this agent for exploratory analysis, hypothesis testing, machine l"
version: v00.37.0
status: ADOPTED
tier: 2
...
primary_domain: data
category: "05-data-ai"
source_file: "agents\community-subagents\categories\05-data-ai\data-scientist.md"
capabilities:
  - data scientist
  - data-ai
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: data-scientist].
