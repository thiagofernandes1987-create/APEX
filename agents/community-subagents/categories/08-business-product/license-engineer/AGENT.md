---
agent_id: subagent.08-business-product.license_engineer
name: "license-engineer"
description: "Use this agent when architecting, implementing, or optimizing end-to-end legal licensing systems—from OSI standard selection and dependency compliance pipelines to proprietary deployment and risk moni"
version: v00.37.0
status: ADOPTED
tier: 3
...
source_file: "agents\community-subagents\categories\08-business-product\license-engineer.md"
capabilities:
  - license engineer
  - business-product
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: license-engineer].
