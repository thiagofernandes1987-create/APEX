---
agent_id: subagent.08-business-product.ux_researcher
name: "ux-researcher"
description: "Use this agent when you need to conduct user research, analyze user behavior, or generate actionable insights to validate design decisions and uncover user needs. Invoke when you need usability testin"
version: v00.37.0
status: ADOPTED
tier: 3
executor: LLM_BEHAVIOR
category: "08-business-product"
source_file: "agents\community-subagents\categories\08-business-product\ux-researcher.md"
capabilities:
  - ux researcher
  - business-product
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: ux-researcher].
