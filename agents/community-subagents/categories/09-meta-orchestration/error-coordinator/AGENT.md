---
agent_id: subagent.09-meta-orchestration.error_coordinator
name: "error-coordinator"
description: "Use this agent when distributed system errors occur and need coordinated handling across multiple components, or when you need to implement comprehensive error recovery strategies with automated failu"
version: v00.37.0
status: ADOPTED
tier: 1
...
source_file: "agents\community-subagents\categories\09-meta-orchestration\error-coordinator.md"
capabilities:
  - error coordinator
  - meta-orchestration
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: error-coordinator].
