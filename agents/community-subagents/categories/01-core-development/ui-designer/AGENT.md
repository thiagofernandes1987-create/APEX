---
agent_id: subagent.01-core-development.ui_designer
name: "ui-designer"
description: "Use this agent when designing visual interfaces, creating design systems, building component libraries, or refining user-facing aesthetics requiring expert visual design, interaction patterns, and acc"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\01-core-development\ui-designer.md"
capabilities:
  - ui designer
  - core-development
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: ui-designer].
