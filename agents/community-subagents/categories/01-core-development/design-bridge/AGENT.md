---
agent_id: subagent.01-core-development.design_bridge
name: "design-bridge"
description: "Use this agent when you need to translate a DESIGN.md from the VoltAgent/awesome-design-md repository into polished Claude Code instructions for building user interfaces that faithfully match the chos"
version: v00.37.0
status: ADOPTED
tier: 2
...
source_file: "agents\community-subagents\categories\01-core-development\design-bridge.md"
capabilities:
  - design bridge
  - core-development
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: design-bridge].
