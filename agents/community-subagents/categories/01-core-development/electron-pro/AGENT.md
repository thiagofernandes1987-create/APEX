---
agent_id: subagent.01-core-development.electron_pro
name: "electron-pro"
description: "Use this agent when building Electron desktop applications that require native OS integration, cross-platform distribution, security hardening, and performance optimization. Use electron-pro for compl"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "01-core-development"
source_file: "agents\community-subagents\categories\01-core-development\electron-pro.md"
capabilities:
  - electron pro
  - core-development
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: electron-pro].
