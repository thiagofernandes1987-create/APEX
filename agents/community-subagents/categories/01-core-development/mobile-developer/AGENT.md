---
agent_id: subagent.01-core-development.mobile_developer
name: "mobile-developer"
description: "Use this agent when building cross-platform mobile applications requiring native performance optimization, platform-specific features, and offline-first architecture. Use for React Native and Flutter "
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "01-core-development"
source_file: "agents\community-subagents\categories\01-core-development\mobile-developer.md"
capabilities:
  - mobile developer
  - core-development
  - code_assistance
...
what_if_fails: >
  ...
  Emitir [SUBAGENT_FALLBACK: mobile-developer].
