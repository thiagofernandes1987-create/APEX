---
agent_id: community.cs_quality_regulatory
...
source_path: "skills/business/personas/cs-quality-regulatory/SKILL.md"
capabilities:
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: cs-quality-regulatory].
