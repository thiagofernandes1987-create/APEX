---
agent_id: community_awesome.laravel.laravel_backend_expert
name: "laravel-backend-expert"
description: "Laravel backend specialist for any Laravel architecture. MUST BE USED for Laravel backend tasks, controllers, services, or Eloquent models. Handles traditional MVC, Inertia.js, Livewire, and API-only "
version: v00.37.0
status: ADOPTED
tier: 2
...
category: "laravel"
source_file: "agents\community-awesome\laravel\laravel-backend-expert.md"
capabilities:
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: laravel-backend-expert].
