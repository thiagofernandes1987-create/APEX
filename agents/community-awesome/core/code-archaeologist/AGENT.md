---
agent_id: community_awesome.core.code_archaeologist
name: "code-archaeologist"
description: "MUST BE USED to explore and document unfamiliar, legacy, or complex codebases. Use PROACTIVELY before refactors, onboarding, audits, or risk reviews. Produces a full-length report—architecture, metric"
version: v00.37.0
status: ADOPTED
tier: 1
executor: LLM_BEHAVIOR
category: "core"
source_file: "agents\community-awesome\core\code-archaeologist.md"
capabilities:
  - code archaeologist
  - core
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: code-archaeologist].
