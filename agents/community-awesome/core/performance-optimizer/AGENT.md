---
agent_id: community_awesome.core.performance_optimizer
name: "performance-optimizer"
description: "MUST BE USED whenever users report slowness, high cloud costs, or scaling concerns. Use PROACTIVELY before traffic spikes. Identifies bottlenecks, profiles workloads, and applies optimisations for bla"
version: v00.37.0
status: ADOPTED
tier: 1
executor: LLM_BEHAVIOR
category: "core"
source_file: "agents\community-awesome\core\performance-optimizer.md"
capabilities:
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: performance-optimizer].
