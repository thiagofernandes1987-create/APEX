---
agent_id: community_awesome.orchestrators.team_configurator
name: "team-configurator"
description: "MUST BE USED to set up—or refresh—the AI development team for the current project. Use PROACTIVELY on new repos or after major tech‑stack changes or when user asks to configure the AI team. Detects th"
version: v00.37.0
status: ADOPTED
tier: 1
executor: LLM_BEHAVIOR
category: "orchestrators"
source_file: "agents\community-awesome\orchestrators\team-configurator.md"
capabilities:
  - team configurator
  - orchestrators
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: team-configurator].
