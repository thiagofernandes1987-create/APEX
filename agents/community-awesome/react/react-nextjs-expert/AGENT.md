---
agent_id: community_awesome.react.react_nextjs_expert
name: "react-nextjs-expert"
description: "Expert in Next.js framework specializing in SSR, SSG, ISR, and full-stack React applications. Provides intelligent, project-aware Next.js solutions that leverage current best practices and integrate w"
version: v00.37.0
status: ADOPTED
tier: 2
...
category: "react"
source_file: "agents\community-awesome\react\react-nextjs-expert.md"
capabilities:
  - react nextjs expert
  - react
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: react-nextjs-expert].
