---
agent_id: community_awesome.python.fastapi_expert
name: "fastapi-expert"
description: "Expert FastAPI spécialisé dans les APIs modernes hautes performances. DOIT ÊTRE UTILISÉ pour le développement d'APIs FastAPI, l'architecture microservices, et l'intégration avec des bases de données a"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "python"
source_file: "agents\community-awesome\python\fastapi-expert.md"
capabilities:
  - fastapi expert
  - python
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: fastapi-expert].
