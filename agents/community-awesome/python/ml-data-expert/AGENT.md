---
agent_id: community_awesome.python.ml_data_expert
name: "ml-data-expert"
description: "Expert en Machine Learning et Data Science avec Python. DOIT ÊTRE UTILISÉ pour l'analyse de données, les modèles ML/AI, le traitement de données, la visualisation avancée, et l'intelligence artificiel"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "python"
source_file: "agents\community-awesome\python\ml-data-expert.md"
capabilities:
  - ml data expert
  - python
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: ml-data-expert].
