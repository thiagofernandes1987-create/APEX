---
agent_id: community_awesome.python.python_expert
name: "python-expert"
description: "Expert développeur Python spécialisé dans le développement moderne Python 3.12+. DOIT ÊTRE UTILISÉ pour les tâches de développement Python, les API FastAPI/Flask, l'architecture des projets Python, et"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "python"
source_file: "agents\community-awesome\python\python-expert.md"
capabilities:
  - python expert
  - python
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: python-expert].
