---
agent_id: community_awesome.python.django_expert
name: "django-expert"
description: "Expert Django spécialisé dans le développement web complet avec Django 5.0+. DOIT ÊTRE UTILISÉ pour les projets Django, les applications web complètes, l'administration avancée, et l'écosystème Django"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "python"
source_file: "agents\community-awesome\python\django-expert.md"
capabilities:
  - django expert
  - python
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: django-expert].
