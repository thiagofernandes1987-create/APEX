---
agent_id: community_awesome.django.django_backend_expert
name: "django-backend-expert"
description: "Expert Django backend developer specializing in models, views, services, and Django-specific implementations. MUST BE USED for Django backend development tasks. Provides intelligent, project-aware sol"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "django"
source_file: "agents\community-awesome\django\django-backend-expert.md"
capabilities:
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: django-backend-expert].
