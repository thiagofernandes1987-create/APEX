---
agent_id: community_awesome.universal.backend_developer
name: "backend-developer"
description: "MUST BE USED whenever server‑side code must be written, extended, or refactored and no framework‑specific sub‑agent exists. Use PROACTIVELY to ship production‑ready features across any language or sta"
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "universal"
source_file: "agents\community-awesome\universal\backend-developer.md"
capabilities:
  - backend developer
  - universal
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: backend-developer].
