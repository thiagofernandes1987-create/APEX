---
agent_id: community_awesome.universal.frontend_developer
name: "frontend-developer"
description: "MUST BE USED to deliver responsive, accessible, high‑performance UIs. Use PROACTIVELY whenever user‑facing code is required and no framework‑specific sub‑agent exists. Capable of working with vanilla "
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "universal"
source_file: "agents\community-awesome\universal\frontend-developer.md"
capabilities:
  - frontend developer
  - universal
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: frontend-developer].
