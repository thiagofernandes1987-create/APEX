---
agent_id: community_awesome.universal.api_architect
name: "api-architect"
description: "Universal API designer specializing in RESTful design, GraphQL schemas, and modern contract standards. **MUST BE USED** proactively whenever a project needs a new or revised API contract. Produces cle"
version: v00.37.0
status: ADOPTED
tier: 2
...
category: "universal"
source_file: "agents\community-awesome\universal\api-architect.md"
capabilities:
  - api architect
  - universal
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: api-architect].
