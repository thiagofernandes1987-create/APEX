---
agent_id: community_awesome.rails.rails_activerecord_expert
name: "rails-activerecord-expert"
description: "Expert in Rails ActiveRecord optimization, complex queries, and database performance. Provides intelligent, project-aware database solutions that integrate seamlessly with existing Rails applications "
version: v00.37.0
status: ADOPTED
tier: 2
executor: LLM_BEHAVIOR
category: "rails"
source_file: "agents\community-awesome\rails\rails-activerecord-expert.md"
capabilities:
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: rails-activerecord-expert].
