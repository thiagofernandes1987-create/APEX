---
agent_id: community_awesome.rails.rails_api_developer
name: "rails-api-developer"
description: "Expert Rails API developer specializing in RESTful APIs and GraphQL. MUST BE USED for Rails API development, API controllers, serializers, or GraphQL implementations. Creates intelligent, project-awar"
version: v00.37.0
status: ADOPTED
tier: 2
...
category: "rails"
source_file: "agents\community-awesome\rails\rails-api-developer.md"
capabilities:
  - rails api developer
  - rails
  - code_generation
...
what_if_fails: >
  ...
  Emitir [AGENT_FALLBACK: rails-api-developer].
