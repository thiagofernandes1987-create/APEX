import { RouteConfig as RouteConfig$1, ZodRequestBody, ZodContentObject, ZodMediaTypeObject, OpenApiGeneratorV3, OpenAPIRegistry } from '../../zod-to-openapi/v3/index';
export { extendZodWithOpenApi } from '../../zod-to-openapi/v3/index';
