...
```bash
npm create voltagent-app@latest -- --example with-airtable
```

Build an Airtable-facing agent that reacts to new records, summarizes them, and writes status/next steps back into the same row using VoltOps Actions. Triggers deliver Airtable events into your agent, and Actions push updates.

Full guide: https://voltagent.dev/recipes-and-guides/airtable-agent/
