...
> **Versão atual:** v3.2.7 (Sprint C — Auto-fix telemetry: tabela `remediations` + endpoints history/stats fechando o loop LEAP 3) · Próximo: Sprint D — AutoFix↔SAST mapping expandido → v3.2.8  
