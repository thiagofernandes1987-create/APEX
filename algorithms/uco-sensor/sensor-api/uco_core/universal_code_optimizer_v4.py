...
from uco_core._v4_transforms import (  # item 4: transforms extraídos
    normalize_ws,
    CodeTransform, ConstantFoldingTransform, EmptyBlockRemover, NoOpAssignmentSimplifier, RedundantConditionEliminator,
    UnreachableAfterTerminalRemoval, AdjacentDuplicateBlockRemoval, BracketWhitespaceNormalizer, DuplicateAdjacentControlBlockMerger, PythonUnusedVarDetector,
)
