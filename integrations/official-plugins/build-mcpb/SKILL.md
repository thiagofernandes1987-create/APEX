---
skill_id: integrations.official_plugins.build_mcpb
name: "build-mcpb"
description: "This skill should be used when the user wants to 'package an MCP server', 'bundle an MCP', 'make an MCPB', 'ship a local MCP server', 'distribute a local MCP', discusses '.mcpb files', mentions bundli"
version: v00.33.0
status: ADOPTED
domain_path: integrations/official-plugins/build-mcpb
anchors:
  - build
  - mcpb
  - this
