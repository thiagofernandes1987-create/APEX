---
skill_id: integrations.official_plugins.build_mcp_server
name: "build-mcp-server"
description: "This skill should be used when the user asks to 'build an MCP server', 'create an MCP', 'make an MCP integration', 'wrap an API for Claude', 'expose tools to Claude', 'make an MCP app', or discusses b"
version: v00.33.0
status: ADOPTED
domain_path: integrations/official-plugins/build-mcp-server
anchors:
  - build
  - server
  - this
