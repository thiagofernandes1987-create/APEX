...
input_schema:
  ...
  triggers:
  - the user asks to automate browser tasks
...
Use this skill when the user asks to automate browser tasks, scrape websites, fill forms, capture screenshots, extract structured
