---
skill_id: engineering_testing.tdd_guide
name: tdd-guide
description: Test-driven development skill for writing unit tests, generating test fixtures and mocks, analyzing coverage
  gaps, and guiding red-green-refactor workflows across Jest, Pytest, JUnit, Vitest, and Moch
version: v00.33.0
status: ADOPTED
...
input_schema:
  ...
  triggers:
  - Test-driven development skill for writing unit tests
...
Test-driven development skill for writing unit tests, generating test fixtures and mocks, analyzing coverage

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires tdd guide capabilities.
