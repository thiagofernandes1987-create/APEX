...
input_schema:
  ...
  triggers:
  - 'Analyzes and rewrites prompts for better AI output
...
Analyze — Analyzes and rewrites prompts for better AI output, creates reusable prompt templates for marketing use cases
