...
version: v00.33.0
status: ADOPTED
domain_path: security/dependency-management-deps-audit
anchors:
- dependency
- management
- deps
...
input_schema:
  ...
  triggers:
  - audit dependency management deps audit task
...
Use this skill when the task requires dependency management deps audit capabilities.
