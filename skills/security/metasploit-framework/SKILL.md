---
skill_id: security.metasploit_framework
name: metasploit-framework
description: '''⚠️ AUTHORIZED USE ONLY > This skill is for educational purposes or authorized security assessments only. >
...
output_schema:
  ...
  description: '1. **Exploitation Evidence** - Screenshots and logs of successful compromises

    2. **Session Logs** - Command history and extracted data

    3. **Vulnerability Mapping** - Exploited vulnerabilities with CVE'
what_if_fails:
