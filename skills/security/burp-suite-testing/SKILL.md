---
skill_id: security.burp_suite_testing
name: "burp-suite-testing"
description: "'Execute comprehensive web application security testing using Burp Suite's integrated toolset, including HTTP traffic interception and modification, request analysis and replay, automated vulnerabilit"
version: v00.33.0
status: CANDIDATE
