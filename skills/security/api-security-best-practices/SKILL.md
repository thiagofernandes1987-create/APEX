---
skill_id: security.api_security_best_practices
name: api-security-best-practices
description: "Audit — "
  and protection against common API vulnerabilities'''
version: v00.33.0
status: ADOPTED
domain_path: security/api-security-best-practices
anchors:
- security
- best
- practices
...
input_schema:
  ...
  triggers:
  - audit api security best practices task
