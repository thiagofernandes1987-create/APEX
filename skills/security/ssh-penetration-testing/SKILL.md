...
description: '''Conduct comprehensive SSH security assessments including enumeration, credential attacks, vulnerability exploitation,
...
output_schema:
  ...
  description: '1. **SSH Enumeration Report** - Versions, algorithms, configurations
