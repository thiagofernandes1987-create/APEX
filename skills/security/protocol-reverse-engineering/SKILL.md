...
version: v00.33.0
status: CANDIDATE
domain_path: security/protocol-reverse-engineering
anchors:
- protocol
- reverse
- engineering
...
input_schema:
  ...
  triggers:
  - audit protocol reverse engineering task
...
Use this skill when the task requires protocol reverse engineering capabilities.
