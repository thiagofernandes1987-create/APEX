...
version: v00.33.0
status: CANDIDATE
domain_path: security/security-scanning-security-hardening
anchors:
- security
- scanning
- hardening
...
input_schema:
  ...
  triggers:
  - audit security scanning security hardening task
...
Use this skill when the task requires security scanning security hardening capabilities.
