...
description: "Apply — Use this skill whenever the user wants to create, read, edit, or manipulate Word documents (.docx files). Triggers"
  ...
  or comments, or converting content into a polished Word document. If the user asks for a ''report'', ''memo'', ''letter'',
  ''template'', or similar deliverable as a Word or .docx file, use this skill. Do NOT use for PDFs, spreadsheets, Google
  Docs, or general coding tasks unrelated to document generation.'
...
synergy_map:
  sales:
    ...
    call_when: Problema requer tanto anthropic-official quanto sales
...
executor: HYBRID
skill_id: anthropic-official._source.skills.docx
status: CANDIDATE
---
