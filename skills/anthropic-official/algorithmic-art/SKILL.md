...
version: v00.33.0
status: ADOPTED
domain_path: anthropic-official/algorithmic-art
anchors:
- algorithmic
- creating
- seeded
...
output_schema:
  ...
  description: 'Output:
    ...
    2. **Single HTML Artifact** - Self-contained interactive generative art built from `templates/viewer.htm'
what_if_fails:
...
synergy_map:
  ...
  knowledge-management:
    ...
    call_when: Problema requer tanto anthropic-official quanto knowledge-management
