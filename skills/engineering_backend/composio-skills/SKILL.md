---
skill_id: engineering_backend.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Hashnode tasks via Rube MCP (Composio)
...
Use this skill when the task requires hashnode automation capabilities.
