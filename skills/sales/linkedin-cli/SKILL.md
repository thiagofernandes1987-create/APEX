...
name: linkedin-cli
description: '''Use when automating LinkedIn via CLI: fetch profiles, search people/companies, send messages, manage connections,
...
output_schema:
  ...
  description: "Success:\n\n```json\n{ \"success\": true, \"data\": { \"name\": \"John Doe\", \"headline\": \"Engineer\" }\
    \ }\n```\n\nError:\n\n```json\n{\n  \"success\": false,\n  \"error\": { \"type\": \"personNotFound\", \"message\": \"\
    Person not f"
what_if_fails:
