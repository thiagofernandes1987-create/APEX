...
name: sequence-load
description: '''Find leads matching criteria and bulk-add them to an Apollo outreach sequence. Handles enrichment, contact
  creation, deduplication, and enrollment in one flow.'''
version: v00.33.0
status: ADOPTED
domain_path: sales/apollo/sequence-load
anchors:
- sequence
- load
- find
