...
description: "'Generate a comprehensive weekly briefing for all external calls in the next 7 days. Triggers on 'weekly prep brief', 'prepare my week', 'what calls do I have this week', 'Monday prep', or any weekly "
version: v00.33.0
status: ADOPTED
domain_path: sales/common-room/weekly-prep-brief
anchors:
  - weekly
  - prep
  - brief
