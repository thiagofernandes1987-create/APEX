---
skill_id: product_management.skills
name: write-spec
description: Write a feature spec or PRD from a problem statement or feature idea. Use when turning a vague idea or user request
  into a structured document, scoping a feature with goals and non-goals, defining suc
version: v00.33.0
status: ADOPTED
domain_path: product-management/skills
anchors:
- write
- spec
- feature
