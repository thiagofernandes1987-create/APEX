...
description: "Use this skill when working with `composition-patterns` tasks in the `engineering_agentops` domain."
...
Provides specialized `composition-patterns` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `composition-patterns` tasks in the `engineering_agentops` domain.
