...
metadata:
  author: vercel
  version: "1.0.0"
skill_id: engineering_agentops.vercel_cli_with_tokens
executor: HYBRID
...
Provides specialized `vercel-cli-with-tokens` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `vercel-cli-with-tokens` tasks in the `engineering_agentops` domain.
