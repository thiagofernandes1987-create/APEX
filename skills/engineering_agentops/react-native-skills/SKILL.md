...
description: "Use this skill when working with `react-native-skills` tasks in the `engineering_agentops` domain."
...
metadata:
  author: vercel
  version: '1.0.0'
skill_id: engineering_agentops.react_native_skills
...
what_if_fails: >
  FALLBACK: If Vercel React Native Skills cannot complete, provide partial results with
...
Provides specialized `react-native-skills` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `react-native-skills` tasks in the `engineering_agentops` domain.
