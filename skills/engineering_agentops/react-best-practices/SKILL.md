...
metadata:
  author: vercel
  version: "1.0.0"
skill_id: engineering_agentops.react_best_practices
...
output_schema:
  - name: report
    type: string
    description: "Analysis report or summary from vercel react best practices"
what_if_fails: >
  FALLBACK: If Vercel React Best Practices cannot complete, provide partial results with
...
Provides specialized `react-best-practices` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `react-best-practices` tasks in the `engineering_agentops` domain.
