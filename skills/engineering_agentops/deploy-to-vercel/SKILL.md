...
metadata:
  author: vercel
  version: "3.0.0"
skill_id: engineering_agentops.deploy_to_vercel
executor: HYBRID
...
Provides specialized `deploy-to-vercel` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `deploy-to-vercel` tasks in the `engineering_agentops` domain.
