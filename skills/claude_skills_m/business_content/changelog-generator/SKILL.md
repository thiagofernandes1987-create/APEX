---
skill_id: claude_skills_m.business_content.changelog_generator
...
output_schema:
  ...
  description: '- Each bullet is user-meaningful, not implementation noise.
