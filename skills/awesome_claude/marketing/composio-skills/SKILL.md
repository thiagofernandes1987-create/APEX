---
skill_id: awesome_claude.marketing.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Aeroleads tasks via Rube MCP (Composio)
...
Use this skill when the task requires aeroleads automation capabilities.
