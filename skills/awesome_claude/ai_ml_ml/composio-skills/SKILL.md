---
skill_id: awesome_claude.ai_ml_ml.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Bigml tasks via Rube MCP (Composio)
...
Use this skill when the task requires bigml automation capabilities.
