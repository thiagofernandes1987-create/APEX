---
skill_id: awesome_claude.engineering_security.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Auth0 tasks via Rube MCP (Composio)
...
Use this skill when the task requires auth0 automation capabilities.
