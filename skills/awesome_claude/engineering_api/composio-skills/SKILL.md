---
skill_id: awesome_claude.engineering_api.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate OneSignal tasks via Rube MCP (Composio)
...
Use this skill when the task requires onesignal rest api automation capabilities.
