---
skill_id: awesome_claude.ai_ml_agents.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Agentql tasks via Rube MCP (Composio)
...
Use this skill when the task requires agentql automation capabilities.
