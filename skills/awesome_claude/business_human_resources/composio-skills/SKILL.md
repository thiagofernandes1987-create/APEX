---
skill_id: awesome_claude.business_human_resources.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate 2chat tasks via Rube MCP (Composio)
...
Use this skill when the task requires  2chat automation capabilities.
