---
skill_id: awesome_claude.ai_ml_llm.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Customgpt tasks via Rube MCP (Composio)
...
Use this skill when the task requires customgpt automation capabilities.
