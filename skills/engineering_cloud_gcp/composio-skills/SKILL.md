...
input_schema:
  ...
  triggers:
  - 'Automate Google BigQuery tasks via Rube MCP (Composio): run SQL queries
...
'Automate Google BigQuery tasks via Rube MCP (Composio): run SQL queries, explore datasets and metadata, execute

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires googlebigquery automation capabilities.
