...
name: "create-viz"
description: "Create publication-quality visualizations with Python. Use when turning query results or a DataFrame into a chart, selecting the right chart type for a trend or comparison, generating a plot for a rep"
version: v00.33.0
status: ADOPTED
domain_path: data-science/analytics/create-viz
anchors:
  - create
  - publication
  - quality
