...
name: "analyze"
description: "Answer data questions -- from quick lookups to full analyses. Use when looking up a single metric, investigating what's driving a trend or drop, comparing segments over time, or preparing a formal dat"
version: v00.33.0
status: ADOPTED
