...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.satismeter-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: satismeter-automation
...
what_if_fails: >
  FALLBACK: If Satismeter Automation cannot complete, provide partial results with
...
Stub for the `satismeter-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `satismeter-automation` tasks via Rube MCP (Composio).
