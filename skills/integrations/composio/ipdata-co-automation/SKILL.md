...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.ipdata-co-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: ipdata-co-automation
...
what_if_fails: >
  FALLBACK: If Ipdata Co Automation cannot complete, provide partial results with
...
Stub for the `ipdata-co-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `ipdata-co-automation` tasks via Rube MCP (Composio).
