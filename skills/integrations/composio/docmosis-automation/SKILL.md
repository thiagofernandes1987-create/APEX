...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.docmosis-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: docmosis-automation
...
what_if_fails: >
  FALLBACK: If Docmosis Automation cannot complete, provide partial results with
...
Stub for the `docmosis-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `docmosis-automation` tasks via Rube MCP (Composio).
