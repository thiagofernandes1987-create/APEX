...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.drip-jobs-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: drip-jobs-automation
...
what_if_fails: >
  FALLBACK: If Drip Jobs Automation cannot complete, provide partial results with
...
Stub for the `drip-jobs-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `drip-jobs-automation` tasks via Rube MCP (Composio).
