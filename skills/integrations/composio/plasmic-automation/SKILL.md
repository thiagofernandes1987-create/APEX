...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.plasmic-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: plasmic-automation
...
what_if_fails: >
  FALLBACK: If Plasmic Automation cannot complete, provide partial results with
...
Stub for the `plasmic-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `plasmic-automation` tasks via Rube MCP (Composio).
