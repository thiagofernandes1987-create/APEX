...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.epic-games-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: epic-games-automation
...
what_if_fails: >
  FALLBACK: If Epic Games Automation cannot complete, provide partial results with
...
Stub for the `epic-games-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `epic-games-automation` tasks via Rube MCP (Composio).
