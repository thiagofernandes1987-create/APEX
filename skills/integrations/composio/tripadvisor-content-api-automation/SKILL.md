...
toolkit: tripadvisor-content-api-automation
...
what_if_fails: >
  FALLBACK: If Tripadvisor Content Api Automation cannot complete, provide partial results with
...
Stub for the `tripadvisor-content-api-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `tripadvisor-content-api-automation` tasks via Rube MCP (Composio).
