...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.fixer-io-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: fixer-io-automation
...
what_if_fails: >
  FALLBACK: If Fixer Io Automation cannot complete, provide partial results with
...
Stub for the `fixer-io-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `fixer-io-automation` tasks via Rube MCP (Composio).
