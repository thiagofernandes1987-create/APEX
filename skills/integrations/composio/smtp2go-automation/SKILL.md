...
what_if_fails: >
  FALLBACK: If Smtp2Go Automation cannot complete, provide partial results with
...
Stub for the `smtp2go-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `smtp2go-automation` tasks via Rube MCP (Composio).
