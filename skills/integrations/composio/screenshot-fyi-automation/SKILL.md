...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.screenshot-fyi-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: screenshot-fyi-automation
...
what_if_fails: >
  FALLBACK: If Screenshot Fyi Automation cannot complete, provide partial results with
...
Stub for the `screenshot-fyi-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `screenshot-fyi-automation` tasks via Rube MCP (Composio).
