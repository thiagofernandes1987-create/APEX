...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.ipinfo-io-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: ipinfo-io-automation
...
what_if_fails: >
  FALLBACK: If Ipinfo Io Automation cannot complete, provide partial results with
...
Stub for the `ipinfo-io-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `ipinfo-io-automation` tasks via Rube MCP (Composio).
