...
what_if_fails: >
  FALLBACK: If Apex27 Automation cannot complete, provide partial results with
...
Stub for the `apex27-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `apex27-automation` tasks via Rube MCP (Composio).
