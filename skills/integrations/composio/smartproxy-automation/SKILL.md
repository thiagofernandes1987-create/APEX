...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.smartproxy-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: smartproxy-automation
...
what_if_fails: >
  FALLBACK: If Smartproxy Automation cannot complete, provide partial results with
...
Stub for the `smartproxy-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `smartproxy-automation` tasks via Rube MCP (Composio).
