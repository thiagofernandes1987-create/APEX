...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.lever-sandbox-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: lever-sandbox-automation
...
what_if_fails: >
  FALLBACK: If Lever Sandbox Automation cannot complete, provide partial results with
...
Stub for the `lever-sandbox-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `lever-sandbox-automation` tasks via Rube MCP (Composio).
