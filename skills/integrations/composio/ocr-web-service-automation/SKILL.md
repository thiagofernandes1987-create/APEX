...
toolkit: ocr-web-service-automation
...
what_if_fails: >
  FALLBACK: If Ocr Web Service Automation cannot complete, provide partial results with
...
Stub for the `ocr-web-service-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `ocr-web-service-automation` tasks via Rube MCP (Composio).
