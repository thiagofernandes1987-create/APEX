...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.new_relic-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: new_relic-automation
...
what_if_fails: >
  FALLBACK: If New_Relic Automation cannot complete, provide partial results with
...
Stub for the `new_relic-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `new_relic-automation` tasks via Rube MCP (Composio).
