...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.currents-api-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: currents-api-automation
...
what_if_fails: >
  FALLBACK: If Currents Api Automation cannot complete, provide partial results with
...
Stub for the `currents-api-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `currents-api-automation` tasks via Rube MCP (Composio).
