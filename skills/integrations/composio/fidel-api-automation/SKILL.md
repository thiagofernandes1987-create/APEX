...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.fidel-api-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: fidel-api-automation
...
what_if_fails: >
  FALLBACK: If Fidel Api Automation cannot complete, provide partial results with
...
Stub for the `fidel-api-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `fidel-api-automation` tasks via Rube MCP (Composio).
