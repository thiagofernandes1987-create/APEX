...
toolkit: digital-ocean-automation
...
what_if_fails: >
  FALLBACK: If Digital Ocean Automation cannot complete, provide partial results with
...
Stub for the `digital-ocean-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `digital-ocean-automation` tasks via Rube MCP (Composio).
