...
toolkit: extracta-ai-automation
...
what_if_fails: >
  FALLBACK: If Extracta Ai Automation cannot complete, provide partial results with
...
Stub for the `extracta-ai-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `extracta-ai-automation` tasks via Rube MCP (Composio).
