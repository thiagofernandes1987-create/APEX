...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.msg91-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: msg91-automation
...
what_if_fails: >
  FALLBACK: If Msg91 Automation cannot complete, provide partial results with
...
Stub for the `msg91-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `msg91-automation` tasks via Rube MCP (Composio).
