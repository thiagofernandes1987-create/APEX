...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.zoho-inventory-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: zoho-inventory-automation
...
what_if_fails: >
  FALLBACK: If Zoho Inventory Automation cannot complete, provide partial results with
...
Stub for the `zoho-inventory-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `zoho-inventory-automation` tasks via Rube MCP (Composio).
