...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.sap-successfactors-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: sap-successfactors-automation
...
what_if_fails: >
  FALLBACK: If Sap Successfactors Automation cannot complete, provide partial results with
...
Stub for the `sap-successfactors-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `sap-successfactors-automation` tasks via Rube MCP (Composio).
