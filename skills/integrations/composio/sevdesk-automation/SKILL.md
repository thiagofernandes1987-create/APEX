...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.sevdesk-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: sevdesk-automation
...
what_if_fails: >
  FALLBACK: If Sevdesk Automation cannot complete, provide partial results with
...
Stub for the `sevdesk-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `sevdesk-automation` tasks via Rube MCP (Composio).
