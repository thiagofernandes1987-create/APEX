...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.safetyculture-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: safetyculture-automation
...
what_if_fails: >
  FALLBACK: If Safetyculture Automation cannot complete, provide partial results with
...
Stub for the `safetyculture-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `safetyculture-automation` tasks via Rube MCP (Composio).
