...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.route4me-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: route4me-automation
...
what_if_fails: >
  FALLBACK: If Route4Me Automation cannot complete, provide partial results with
...
Stub for the `route4me-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `route4me-automation` tasks via Rube MCP (Composio).
