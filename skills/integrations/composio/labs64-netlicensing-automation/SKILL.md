...
what_if_fails: >
  FALLBACK: If Labs64 Netlicensing Automation cannot complete, provide partial results with
...
Stub for the `labs64-netlicensing-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `labs64-netlicensing-automation` tasks via Rube MCP (Composio).
