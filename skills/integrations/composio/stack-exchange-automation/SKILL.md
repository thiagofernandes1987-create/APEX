...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.stack-exchange-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: stack-exchange-automation
...
what_if_fails: >
  FALLBACK: If Stack Exchange Automation cannot complete, provide partial results with
...
Stub for the `stack-exchange-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `stack-exchange-automation` tasks via Rube MCP (Composio).
