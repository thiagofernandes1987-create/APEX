...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.contentful-graphql-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: contentful-graphql-automation
...
what_if_fails: >
  FALLBACK: If Contentful Graphql Automation cannot complete, provide partial results with
...
Stub for the `contentful-graphql-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `contentful-graphql-automation` tasks via Rube MCP (Composio).
