...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.icypeas-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: icypeas-automation
...
what_if_fails: >
  FALLBACK: If Icypeas Automation cannot complete, provide partial results with
...
Stub for the `icypeas-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `icypeas-automation` tasks via Rube MCP (Composio).
