...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.here-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: here-automation
...
what_if_fails: >
  FALLBACK: If Here Automation cannot complete, provide partial results with
...
Stub for the `here-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `here-automation` tasks via Rube MCP (Composio).
