...
what_if_fails: >
  FALLBACK: If V0 Automation cannot complete, provide partial results with
...
Stub for the `v0-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `v0-automation` tasks via Rube MCP (Composio).
