...
toolkit: doppler-marketing-automation-automation
...
what_if_fails: >
  FALLBACK: If Doppler Marketing Automation Automation cannot complete, provide partial results with
...
Stub for the `doppler-marketing-automation-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `doppler-marketing-automation-automation` tasks via Rube MCP (Composio).
