...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.zeplin-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: zeplin-automation
...
what_if_fails: >
  FALLBACK: If Zeplin Automation cannot complete, provide partial results with
...
Stub for the `zeplin-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `zeplin-automation` tasks via Rube MCP (Composio).
