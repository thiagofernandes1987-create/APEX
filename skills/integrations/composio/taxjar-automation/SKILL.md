...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.taxjar-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: taxjar-automation
...
what_if_fails: >
  FALLBACK: If Taxjar Automation cannot complete, provide partial results with
...
Stub for the `taxjar-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `taxjar-automation` tasks via Rube MCP (Composio).
