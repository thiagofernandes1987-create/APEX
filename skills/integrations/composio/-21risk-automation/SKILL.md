...
what_if_fails: >
  FALLBACK: If  21Risk Automation cannot complete, provide partial results with
...
Stub for the `21risk-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `21risk-automation` tasks via Rube MCP (Composio).
