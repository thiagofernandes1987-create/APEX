...
toolkit: salesforce-marketing-cloud-automation
...
what_if_fails: >
  FALLBACK: If Salesforce Marketing Cloud Automation cannot complete, provide partial results with
...
Stub for the `salesforce-marketing-cloud-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `salesforce-marketing-cloud-automation` tasks via Rube MCP (Composio).
