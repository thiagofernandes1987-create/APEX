...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.onesignal-rest-api-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: onesignal-rest-api-automation
...
what_if_fails: >
  FALLBACK: If Onesignal Rest Api Automation cannot complete, provide partial results with
...
Stub for the `onesignal-rest-api-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `onesignal-rest-api-automation` tasks via Rube MCP (Composio).
