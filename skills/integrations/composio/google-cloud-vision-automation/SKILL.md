...
toolkit: google-cloud-vision-automation
...
what_if_fails: >
  FALLBACK: If Google Cloud Vision Automation cannot complete, provide partial results with
...
Stub for the `google-cloud-vision-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `google-cloud-vision-automation` tasks via Rube MCP (Composio).
