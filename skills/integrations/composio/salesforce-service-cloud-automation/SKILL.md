...
toolkit: salesforce-service-cloud-automation
...
what_if_fails: >
  FALLBACK: If Salesforce Service Cloud Automation cannot complete, provide partial results with
...
Stub for the `salesforce-service-cloud-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `salesforce-service-cloud-automation` tasks via Rube MCP (Composio).
