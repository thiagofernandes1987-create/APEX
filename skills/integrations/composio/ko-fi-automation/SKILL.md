...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.ko-fi-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: ko-fi-automation
...
what_if_fails: >
  FALLBACK: If Ko Fi Automation cannot complete, provide partial results with
...
Stub for the `ko-fi-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `ko-fi-automation` tasks via Rube MCP (Composio).
