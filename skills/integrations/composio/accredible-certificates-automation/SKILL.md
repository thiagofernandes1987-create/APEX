...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.accredible-certificates-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: accredible-certificates-automation
...
what_if_fails: >
  FALLBACK: If Accredible Certificates Automation cannot complete, provide partial results with
...
Stub for the `accredible-certificates-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `accredible-certificates-automation` tasks via Rube MCP (Composio).
