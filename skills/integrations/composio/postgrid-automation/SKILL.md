...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.postgrid-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: postgrid-automation
...
what_if_fails: >
  FALLBACK: If Postgrid Automation cannot complete, provide partial results with
...
Stub for the `postgrid-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `postgrid-automation` tasks via Rube MCP (Composio).
