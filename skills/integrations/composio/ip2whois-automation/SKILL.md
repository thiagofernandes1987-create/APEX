...
what_if_fails: >
  FALLBACK: If Ip2Whois Automation cannot complete, provide partial results with
...
Stub for the `ip2whois-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `ip2whois-automation` tasks via Rube MCP (Composio).
