...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.textrazor-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: textrazor-automation
...
what_if_fails: >
  FALLBACK: If Textrazor Automation cannot complete, provide partial results with
...
Stub for the `textrazor-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `textrazor-automation` tasks via Rube MCP (Composio).
