...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.draftable-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: draftable-automation
...
what_if_fails: >
  FALLBACK: If Draftable Automation cannot complete, provide partial results with
...
Stub for the `draftable-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `draftable-automation` tasks via Rube MCP (Composio).
