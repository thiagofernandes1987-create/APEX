...
what_if_fails: >
  FALLBACK: If U301 Automation cannot complete, provide partial results with
...
Stub for the `u301-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `u301-automation` tasks via Rube MCP (Composio).
