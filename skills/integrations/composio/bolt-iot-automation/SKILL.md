...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.bolt-iot-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: bolt-iot-automation
...
what_if_fails: >
  FALLBACK: If Bolt Iot Automation cannot complete, provide partial results with
...
Stub for the `bolt-iot-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `bolt-iot-automation` tasks via Rube MCP (Composio).
