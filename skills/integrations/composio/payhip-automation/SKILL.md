...
requires:
  mcp: [rube]
executor: HYBRID
skill_id: integrations.composio.payhip-automation
status: ADOPTED
security: {level: standard, pii: false, approval_required: false}
extends: integrations.composio.meta
toolkit: payhip-automation
...
what_if_fails: >
  FALLBACK: If Payhip Automation cannot complete, provide partial results with
...
Stub for the `payhip-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `payhip-automation` tasks via Rube MCP (Composio).
