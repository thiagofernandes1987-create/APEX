...
what_if_fails: >
  FALLBACK: If Mem0 Automation cannot complete, provide partial results with
...
Stub for the `mem0-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `mem0-automation` tasks via Rube MCP (Composio).
