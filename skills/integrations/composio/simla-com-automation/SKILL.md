...
what_if_fails: >
  FALLBACK: If Simla Com Automation cannot complete, provide partial results with
...
Stub for the `simla-com-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `simla-com-automation` tasks via Rube MCP (Composio).
