...
what_if_fails: >
  FALLBACK: If L2S Automation cannot complete, provide partial results with
...
Stub for the `l2s-automation` toolkit in the Composio integration ecosystem.
Extends `integrations.composio.meta` — see the meta-skill for full protocol.

## When to Use
Use when automating `l2s-automation` tasks via Rube MCP (Composio).
