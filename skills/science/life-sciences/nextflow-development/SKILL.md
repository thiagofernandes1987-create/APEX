...
description: "Run nf-core bioinformatics pipelines (rnaseq, sarek, atacseq) on sequencing data. Use when analyzing RNA-seq, WGS/WES, or ATAC-seq data—either local FASTQs or public datasets from GEO/SRA. Triggers on"
version: v00.33.0
status: ADOPTED
domain_path: science/life-sciences/nextflow-development
anchors:
  - nextflow
  - development
  - core
