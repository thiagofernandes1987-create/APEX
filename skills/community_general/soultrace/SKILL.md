...
skill_id: community_general.soultrace
executor: HYBRID
...
Take an adaptive personality assessment through the [soultrace](https://soultrace.app/en) API. Answer 24 questions on a 1-7 Likert scale and receive your personality archetype based on a 5-color psychological model.
...
Provides specialized `soultrace` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `soultrace` tasks in the `community_general` domain.

## What If Fails
<!-- TODO: describe fallback behavior -->
FALLBACK: Use a related skill in the `community_general` domain.
