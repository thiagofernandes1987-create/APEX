...
input_schema:
  ...
  triggers:
  - Optimize content to get cited by AI search engines — ChatGPT
...
Optimize content to get cited by AI search engines — ChatGPT, Perplexity, Google AI Overviews, Claude, Gemini,
