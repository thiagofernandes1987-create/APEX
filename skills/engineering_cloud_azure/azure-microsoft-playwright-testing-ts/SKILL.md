---
skill_id: engineering_cloud_azure.azure_microsoft_playwright_testing_ts
name: azure-microsoft-playwright-testing-ts
description: 'Run Playwright tests at scale using Azure Playwright Workspaces (formerly Microsoft Playwright Testing). Use
  when scaling browser tests across cloud-hosted browsers, integrating with CI/CD pipelines, '
version: v00.33.0
status: CANDIDATE
...
input_schema:
  ...
  triggers:
  - 'Run Playwright tests at scale using Azure Playwright Workspaces (formerly Microsoft Playwright Test
...
'Run Playwright tests at scale using Azure Playwright Workspaces (formerly Microsoft Playwright Testing). Use

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires azure microsoft playwright testing ts capabilities.
