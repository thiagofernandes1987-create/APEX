...
input_schema:
  ...
  triggers:
  - implementing DefaultAzureCredential
...
Use — Azure Identity library for Java authentication with Azure services.

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when implementing DefaultAzureCredential,
