---
skill_id: engineering_cloud_azure.azure_containerregistry_py
...
input_schema:
  ...
  triggers:
  - use azure containerregistry py task
...
Use this skill when the task requires azure containerregistry py capabilities.
