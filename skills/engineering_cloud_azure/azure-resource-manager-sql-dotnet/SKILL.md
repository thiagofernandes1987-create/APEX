---
skill_id: engineering_cloud_azure.azure_resource_manager_sql_dotnet
...
input_schema:
  ...
  triggers:
  - use azure resource manager sql dotnet task
...
Use this skill when the task requires azure resource manager sql dotnet capabilities.
