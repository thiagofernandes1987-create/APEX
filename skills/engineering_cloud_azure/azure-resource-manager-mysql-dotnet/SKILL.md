---
skill_id: engineering_cloud_azure.azure_resource_manager_mysql_dotnet
...
input_schema:
  ...
  triggers:
  - use azure resource manager mysql dotnet task
...
Use this skill when the task requires azure resource manager mysql dotnet capabilities.
