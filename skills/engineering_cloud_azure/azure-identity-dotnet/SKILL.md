---
skill_id: engineering_cloud_azure.azure_identity_dotnet
...
input_schema:
  ...
  triggers:
  - use azure identity dotnet task
...
Use this skill when the task requires azure identity dotnet capabilities.
