---
skill_id: engineering_cloud_azure.azure_appconfiguration_py
...
input_schema:
  ...
  triggers:
  - use azure appconfiguration py task
...
Use this skill when the task requires azure appconfiguration py capabilities.
