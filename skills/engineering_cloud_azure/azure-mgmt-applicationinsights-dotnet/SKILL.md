---
skill_id: engineering_cloud_azure.azure_mgmt_applicationinsights_dotnet
...
input_schema:
  ...
  triggers:
  - use azure mgmt applicationinsights dotnet task
...
Use this skill when the task requires azure mgmt applicationinsights dotnet capabilities.
