...
input_schema:
  ...
  triggers:
  - 'Configure Azure API Management as an AI Gateway for AI models
...
'Configure Azure API Management as an AI Gateway for AI models, MCP tools, and agents. WHEN: semantic caching,
