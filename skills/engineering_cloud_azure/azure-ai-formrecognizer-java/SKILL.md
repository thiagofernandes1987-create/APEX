---
skill_id: engineering_cloud_azure.azure_ai_formrecognizer_java
name: azure-ai-formrecognizer-java
description: 'Build document analysis applications with Azure Document Intelligence (Form Recognizer) SDK for Java. Use when
  extracting text, tables, key-value pairs from documents, receipts, invoices, or building '
version: v00.33.0
status: CANDIDATE
...
input_schema:
  ...
  triggers:
  - 'Build document analysis applications with Azure Document Intelligence (Form Recognizer) SDK for Jav
...
Use this skill when the task requires azure ai formrecognizer java capabilities.
