---
skill_id: engineering_cloud_azure.azure_eventhub_dotnet
...
input_schema:
  ...
  triggers:
  - use azure eventhub dotnet task
...
Use this skill when the task requires azure eventhub dotnet capabilities.
