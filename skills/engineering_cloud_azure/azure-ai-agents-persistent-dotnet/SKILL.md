---
skill_id: engineering_cloud_azure.azure_ai_agents_persistent_dotnet
...
input_schema:
  ...
  triggers:
  - use azure ai agents persistent dotnet task
...
Use this skill when the task requires azure ai agents persistent dotnet capabilities.
