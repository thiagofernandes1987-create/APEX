---
skill_id: engineering_cloud_azure.azure_appconfiguration_java
...
input_schema:
  ...
  triggers:
  - use azure appconfiguration java task
...
Use this skill when the task requires azure appconfiguration java capabilities.
