---
skill_id: engineering_cloud_azure.azure_mgmt_weightsandbiases_dotnet
...
input_schema:
  ...
  triggers:
  - use azure mgmt weightsandbiases dotnet task
...
Use this skill when the task requires azure mgmt weightsandbiases dotnet capabilities.
