---
skill_id: engineering_cloud_azure.azure_cloud_architect
...
input_schema:
  ...
  triggers:
  - asked to design Azure infrastructure
...
Use this skill when asked to design Azure infrastructure, create
