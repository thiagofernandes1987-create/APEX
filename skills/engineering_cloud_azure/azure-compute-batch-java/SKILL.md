---
skill_id: engineering_cloud_azure.azure_compute_batch_java
...
input_schema:
  ...
  triggers:
  - use azure compute batch java task
...
Use this skill when the task requires azure compute batch java capabilities.
