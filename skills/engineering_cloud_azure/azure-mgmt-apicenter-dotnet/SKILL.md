---
skill_id: engineering_cloud_azure.azure_mgmt_apicenter_dotnet
...
input_schema:
  ...
  triggers:
  - use azure mgmt apicenter dotnet task
...
Use this skill when the task requires azure mgmt apicenter dotnet capabilities.
