---
skill_id: engineering_cloud_azure.azure_ai_translation_document_py
...
input_schema:
  ...
  triggers:
  - use azure ai translation document py task
...
Use this skill when the task requires azure ai translation document py capabilities.
