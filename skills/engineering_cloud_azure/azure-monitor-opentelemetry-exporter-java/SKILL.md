---
skill_id: engineering_cloud_azure.azure_monitor_opentelemetry_exporter_java
...
input_schema:
  ...
  triggers:
  - use azure monitor opentelemetry exporter java task
...
Use this skill when the task requires azure monitor opentelemetry exporter java capabilities.
