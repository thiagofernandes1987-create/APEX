---
skill_id: engineering_cloud_azure.azure_storage_blob_rust
...
input_schema:
  ...
  triggers:
  - use azure storage blob rust task
...
Use this skill when the task requires azure storage blob rust capabilities.
