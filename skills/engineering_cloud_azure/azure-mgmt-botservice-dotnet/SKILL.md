---
skill_id: engineering_cloud_azure.azure_mgmt_botservice_dotnet
...
input_schema:
  ...
  triggers:
  - use azure mgmt botservice dotnet task
...
Use this skill when the task requires azure mgmt botservice dotnet capabilities.
