---
skill_id: engineering_cloud_azure.azure_ai_document_intelligence_ts
...
Use this skill when the task requires azure ai document intelligence ts capabilities.
