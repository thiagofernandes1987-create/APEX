---
skill_id: engineering_cloud_azure.azure_mgmt_fabric_dotnet
...
input_schema:
  ...
  triggers:
  - use azure mgmt fabric dotnet task
...
Use this skill when the task requires azure mgmt fabric dotnet capabilities.
