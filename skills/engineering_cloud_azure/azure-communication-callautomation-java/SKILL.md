---
skill_id: engineering_cloud_azure.azure_communication_callautomation_java
name: azure-communication-callautomation-java
description: Build call automation workflows with Azure Communication Services Call Automation Java SDK. Use when implementing
  IVR systems, call routing, call recording, DTMF recognition, text-to-speech, or AI-pow
version: v00.33.0
status: CANDIDATE
