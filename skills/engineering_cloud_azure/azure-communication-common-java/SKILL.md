---
skill_id: engineering_cloud_azure.azure_communication_common_java
...
input_schema:
  ...
  triggers:
  - working with CommunicationTokenCredential
...
Use — Azure Communication Services common utilities for Java.

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when orking with CommunicationTokenCredential, user
