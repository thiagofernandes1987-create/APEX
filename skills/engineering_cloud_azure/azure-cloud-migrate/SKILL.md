...
input_schema:
  ...
  triggers:
  - 'Assess and migrate cross-cloud workloads to Azure with migration reports and code conversion
...
output_schema:
  ...
  description: All output goes to `<source-folder>-azure/` at workspace root. Never modify the source directory.
what_if_fails:
...
'Assess and migrate cross-cloud workloads to Azure with migration reports and code conversion. Supports AWS Lambda→Functions

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires azure cloud migrate capabilities.
