---
skill_id: engineering_cloud_azure.azure_ai_translation_text_py
...
input_schema:
  ...
  triggers:
  - use azure ai translation text py task
...
Use this skill when the task requires azure ai translation text py capabilities.
