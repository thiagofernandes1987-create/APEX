---
skill_id: engineering_cloud_azure.azure_ai_transcription_py
...
input_schema:
  ...
  triggers:
  - use azure ai transcription py task
...
Use this skill when the task requires azure ai transcription py capabilities.
