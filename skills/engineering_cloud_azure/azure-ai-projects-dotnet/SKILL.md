---
skill_id: engineering_cloud_azure.azure_ai_projects_dotnet
...
input_schema:
  ...
  triggers:
  - use azure ai projects dotnet task
...
Use this skill when the task requires azure ai projects dotnet capabilities.
