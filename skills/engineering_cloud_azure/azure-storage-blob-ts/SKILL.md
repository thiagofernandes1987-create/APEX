---
skill_id: engineering_cloud_azure.azure_storage_blob_ts
...
input_schema:
  ...
  triggers:
  - use azure storage blob ts task
...
Use this skill when the task requires azure storage blob ts capabilities.
