---
skill_id: engineering_cloud_azure.azure_messaging_webpubsubservice_py
...
input_schema:
  ...
  triggers:
  - use azure messaging webpubsubservice py task
...
Use this skill when the task requires azure messaging webpubsubservice py capabilities.
