---
skill_id: engineering_cloud_azure.cloud_solution_architect
...
input_schema:
  ...
  triggers:
  - use cloud solution architect task
...
Use this skill when the task requires cloud solution architect capabilities.
