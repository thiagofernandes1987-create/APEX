---
skill_id: engineering_cloud_azure.azure_storage_queue_ts
...
input_schema:
  ...
  triggers:
  - use azure storage queue ts task
...
Use this skill when the task requires azure storage queue ts capabilities.
