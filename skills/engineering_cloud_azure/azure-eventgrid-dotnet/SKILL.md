---
skill_id: engineering_cloud_azure.azure_eventgrid_dotnet
...
input_schema:
  ...
  triggers:
  - use azure eventgrid dotnet task
...
Use this skill when the task requires azure eventgrid dotnet capabilities.
