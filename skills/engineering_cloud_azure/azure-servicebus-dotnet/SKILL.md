---
skill_id: engineering_cloud_azure.azure_servicebus_dotnet
...
input_schema:
  ...
  triggers:
  - use azure servicebus dotnet task
...
Use this skill when the task requires azure servicebus dotnet capabilities.
