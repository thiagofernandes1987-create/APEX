...
input_schema:
  ...
  triggers:
  - the user asks to set up secret management infrastructure
...
Use this skill when the user asks to set up secret management infrastructure, integrate HashiCorp Vault, configure cloud
