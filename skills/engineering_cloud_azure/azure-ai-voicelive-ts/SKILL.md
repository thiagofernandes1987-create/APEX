---
skill_id: engineering_cloud_azure.azure_ai_voicelive_ts
...
input_schema:
  ...
  triggers:
  - use azure ai voicelive ts task
...
Use this skill when the task requires azure ai voicelive ts capabilities.
