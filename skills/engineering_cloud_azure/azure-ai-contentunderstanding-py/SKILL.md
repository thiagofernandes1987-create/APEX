---
skill_id: engineering_cloud_azure.azure_ai_contentunderstanding_py
...
input_schema:
  ...
  triggers:
  - use azure ai contentunderstanding py task
...
Use this skill when the task requires azure ai contentunderstanding py capabilities.
