---
skill_id: engineering_cloud_azure.azure_storage_file_share_py
...
input_schema:
  ...
  triggers:
  - use azure storage file share py task
...
Use this skill when the task requires azure storage file share py capabilities.
