---
skill_id: engineering_cloud_azure.azure_search_documents_py
...
input_schema:
  ...
  triggers:
  - use azure search documents py task
...
Use this skill when the task requires azure search documents py capabilities.
