...
input_schema:
  ...
  triggers:
  - Terraform infrastructure-as-code agent skill and plugin for Claude Code
...
Use — Terraform infrastructure-as-code agent skill and plugin for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw.
