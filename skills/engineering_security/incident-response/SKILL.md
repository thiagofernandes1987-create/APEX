...
input_schema:
  ...
  triggers:
  - a security incident has been detected or declared and needs classification
...
Use this skill when a security incident has been detected or declared and needs classification, triage, escalation path
