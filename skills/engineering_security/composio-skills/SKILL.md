...
input_schema:
  ...
  triggers:
  - Automate SEO research with Ahrefs -- analyze backlink profiles
...
Automate SEO research with Ahrefs -- analyze backlink profiles, research keywords, track domain metrics history,

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires ahrefs automation capabilities.
