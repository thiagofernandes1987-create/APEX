---
skill_id: engineering_security.pr_review_expert
name: pr-review-expert
description: Use when the user asks to review pull requests, analyze code changes, check for security issues in PRs, or assess
...
output_schema:
  ...
  description: 'Structure your review comment as:
