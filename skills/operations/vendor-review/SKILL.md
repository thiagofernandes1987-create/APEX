...
name: "vendor-review"
description: "Evaluate a vendor — cost analysis, risk assessment, and recommendation. Use when reviewing a new vendor proposal, deciding whether to renew or replace a contract, comparing two vendors side-by-side, o"
version: v00.33.0
status: ADOPTED
domain_path: operations/vendor-review
anchors:
  - vendor
  - review
  - evaluate
