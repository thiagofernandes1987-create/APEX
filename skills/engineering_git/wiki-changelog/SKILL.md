---
skill_id: engineering_git.wiki_changelog
name: wiki-changelog
description: "Generate — Analyzes git commit history and generates structured changelogs categorized by change type. Use when the user"
  asks about recent changes, wants a changelog, or needs to understand what changed in the r
version: v00.33.0
status: CANDIDATE
...
Generate — Analyzes git commit history and generates structured changelogs categorized by change type.

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires wiki changelog capabilities.
