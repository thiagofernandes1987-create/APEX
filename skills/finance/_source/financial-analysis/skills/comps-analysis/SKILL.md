---
name: comps-analysis
description: 'Build institutional-grade comparable company analyses with operating metrics, valuation multiples, and statistical
  benchmarking in Excel/spreadsheet format.
...
input_schema:
  ...
  triggers:
  - 'Build institutional-grade comparable company analyses with operating metrics
...
output_schema:
  ...
  description: 'Before delivering a comp analysis, verify:
...
skill_id: finance.financial_analysis.comps_analysis_3
status: CANDIDATE
---
...
'Build institutional-grade comparable company analyses with operating metrics, valuation multiples, and statistical

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires comps analysis capabilities.
