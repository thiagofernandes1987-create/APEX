...
description: 'Build professional financial services data packs from various sources including CIMs, offering memorandums,
  SEC filings, web search, or MCP servers. Extract, normalize, and standardize financial data '
version: v00.33.0
status: ADOPTED
domain_path: finance/investment-banking/datapack-builder
anchors:
- datapack
- builder
- build
...
'Build professional financial services data packs from various sources including CIMs, offering memorandums,
