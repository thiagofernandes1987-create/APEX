...
description: "Create professional equity research earnings update reports (8-12 pages, 3,000-5,000 words) analyzing quarterly results for companies already under coverage. Fast-turnaround format focusing on beat/mi"
version: v00.33.0
status: ADOPTED
domain_path: finance/equity-research/earnings-analysis
anchors:
  - earnings
  - analysis
  - create
