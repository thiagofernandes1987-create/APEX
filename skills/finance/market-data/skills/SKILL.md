---
skill_id: finance.market_data.skills
name: "tear-sheet"
description: "'Generate professional company tear sheets using S&P Capital IQ data via the Kensho LLM-ready API MCP server. Use this skill whenever the user asks for a tear sheet, company one-pager, company profile"
version: v00.33.0
status: ADOPTED
domain_path: finance/market-data/skills
anchors:
  - tear
  - sheet
  - generate
