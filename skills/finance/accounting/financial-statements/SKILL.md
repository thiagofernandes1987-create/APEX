...
description: "Generate financial statements (income statement, balance sheet, cash flow) with period-over-period comparison and variance analysis. Use when preparing a monthly or quarterly P&L, closing the books an"
version: v00.33.0
status: ADOPTED
domain_path: finance/accounting/financial-statements
anchors:
  - financial
  - statements
  - generate
