...
name: "audit-support"
description: "Support SOX 404 compliance with control testing methodology, sample selection, and documentation standards. Use when generating testing workpapers, selecting audit samples, classifying control deficie"
version: v00.33.0
status: ADOPTED
domain_path: finance/accounting/audit-support
anchors:
  - audit
  - support
  - compliance
