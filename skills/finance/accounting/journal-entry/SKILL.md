...
name: "journal-entry"
description: "Prepare journal entries with proper debits, credits, and supporting detail. Use when booking month-end accruals (AP, payroll, prepaid), recording depreciation or amortization, posting revenue recognit"
version: v00.33.0
status: ADOPTED
domain_path: finance/accounting/journal-entry
anchors:
  - journal
  - entry
  - prepare
