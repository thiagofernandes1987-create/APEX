...
name: "lbo-model"
description: "This skill should be used when completing LBO (Leveraged Buyout) model templates in Excel for private equity transactions, deal materials, or investment committee presentations. The skill fills in for"
version: v00.33.0
status: ADOPTED
domain_path: finance/financial-analysis/lbo-model
anchors:
  - model
  - skill
  - completing
