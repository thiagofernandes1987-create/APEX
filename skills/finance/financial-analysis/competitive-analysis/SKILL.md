...
description: "Framework for building competitive landscape decks — market positioning, competitor deep-dives, comparative analysis, strategic synthesis. Use when the user asks for a competitive landscape, competito"
version: v00.33.0
status: ADOPTED
domain_path: finance/financial-analysis/competitive-analysis
anchors:
  - competitive
  - analysis
  - framework
