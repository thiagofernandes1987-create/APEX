...
name: "deck-refresh"
description: "Updates a presentation with new numbers — quarterly refreshes, earnings updates, comp rolls, rebased market data. Use whenever the user asks to 'update the deck with Q4 numbers', 'refresh the comps', "
version: v00.33.0
status: ADOPTED
