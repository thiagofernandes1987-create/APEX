...
name: "dcf-model"
description: "Real DCF (Discounted Cash Flow) model creation for equity valuation. Retrieves financial data from SEC filings and analyst reports, builds comprehensive cash flow projections with proper WACC calculat"
version: v00.33.0
status: ADOPTED
domain_path: finance/financial-analysis/dcf-model
anchors:
  - model
  - real
  - discounted
