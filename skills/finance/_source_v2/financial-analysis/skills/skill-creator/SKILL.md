...
description: "Analyze — Guide for creating effective skills. This skill should be used when users want to create a new skill (or update"
  an existing skill) that extends Claude's capabilities with specialized knowledge, workflows, or tool integrations.
...
executor: HYBRID
skill_id: finance.financial_analysis.skill_creator_2
status: CANDIDATE
---
# Skill Creator
