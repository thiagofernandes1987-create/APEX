...
description: "Analyze the bond futures basis by pricing futures, identifying the cheapest-to-deliver, and comparing with yield curves to assess delivery option value and basis trading opportunities. Use when analyz"
version: v00.33.0
status: ADOPTED
domain_path: finance/fixed-income/bond-futures-basis
anchors:
  - bond
  - futures
  - basis
