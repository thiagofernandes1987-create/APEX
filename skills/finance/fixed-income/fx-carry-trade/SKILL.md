...
name: "fx-carry-trade"
description: "Evaluate FX carry trade opportunities by combining spot rates, forward points, interest rate differentials, volatility surface analysis, and historical price trends. Use when analyzing carry trades, c"
version: v00.33.0
status: ADOPTED
domain_path: finance/fixed-income/fx-carry-trade
anchors:
  - carry
  - trade
  - evaluate
