---
skill_id: finance.fixed_income.skills
name: "swap-curve-strategy"
description: "Analyze the interest rate swap curve by pricing swaps at multiple tenors, overlaying government and inflation curves, and identifying curve trade opportunities. Use when analyzing swap curves, computi"
version: v00.33.0
status: ADOPTED
domain_path: finance/fixed-income/skills
anchors:
  - swap
  - curve
  - strategy
