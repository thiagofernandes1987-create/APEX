...
description: Build an interactive HTML dashboard with charts, filters, and tables. Use when creating an executive overview
  with KPI cards, turning query results into a shareable self-contained report, building a team monitoring snapshot, or needing
...
skill_id: knowledge_work.data.build_dashboard_2
status: CANDIDATE
---
...
Use this skill when creating an executive overview
