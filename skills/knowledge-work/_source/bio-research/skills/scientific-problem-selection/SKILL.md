...
description: "Use — This skill should be used when scientists need help with research problem selection, project ideation, troubleshooting"
...
skill_id: knowledge_work.bio_research.scientific_problem_selection_2
status: ADOPTED
---
...
Use — This skill should be used when scientists need help with research problem selection, project ideation, troubleshooting
