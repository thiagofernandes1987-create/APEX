...
description: Manage the month-end close process with task sequencing, dependencies, and status tracking. Use when planning
  the close calendar, tracking close progress, identifying blockers, or sequencing close activities by day.
...
input_schema:
  ...
  triggers:
  - Manage the month-end close process with task sequencing
...
skill_id: knowledge_work.finance.close_management_2
status: ADOPTED
---
# Close Management
...
Use this skill when the task requires close management capabilities.
