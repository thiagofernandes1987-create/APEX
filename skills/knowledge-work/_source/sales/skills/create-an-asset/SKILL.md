...
description: Generate tailored sales assets (landing pages, decks, one-pagers, workflow demos) from your deal context. Describe
  your prospect, audience, and goal — get a polished, branded asset ready to share with customers.
tier: ADAPTED
anchors:
- create-an-asset
- generate
...
output_schema:
  ...
  description: '**All formats**: Self-contained HTML file
...
skill_id: knowledge_work.sales.create_an_asset_2
status: ADOPTED
---
# Create an Asset
...
Generate tailored sales assets (landing pages, decks, one-pagers, workflow demos) from your deal context. Describe

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires create an asset capabilities.
