...
description: Run a WCAG 2.1 AA accessibility audit on a design or page. Trigger with "audit accessibility", "check a11y",
  "is this accessible?", or when reviewing a design for color contrast, keyboard navigation, touch target size, or screen
...
skill_id: knowledge_work.design.accessibility_review_2
status: CANDIDATE
---
# /accessibility-review
