...
description: Generate a comprehensive weekly briefing for all external calls in the next 7 days. Triggers on 'weekly prep
  brief', 'prepare my week', 'what calls do I have this week', 'Monday prep', or any weekly planning request.
tier: ADAPTED
anchors:
- weekly-prep-brief
- generate
...
skill_id: knowledge_work.partner_built.common_room.weekly_prep_brief_2
status: CANDIDATE
---
# Weekly Prep Brief
