...
description: Build a marketing performance report with key metrics, trend analysis, wins and misses, and prioritized optimization
  recommendations. Use when wrapping a campaign, when preparing weekly, monthly, or quarterly channel summaries for stakeholders,
...
skill_id: knowledge_work.marketing.performance_report
status: ADOPTED
---
# Performance Report
