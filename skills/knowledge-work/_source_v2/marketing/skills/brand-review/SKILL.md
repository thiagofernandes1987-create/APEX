---
name: brand-review
description: Review content against your brand voice, style guide, and messaging pillars, flagging deviations by severity
  with specific before/after fixes. Use when checking a draft before it ships, when auditing copy for voice consistency and
...
input_schema:
  ...
  triggers:
  - Review content against your brand voice
...
output_schema:
  ...
  description: 'Present the review as:'
what_if_fails:
...
skill_id: knowledge-work._source_v2.marketing.skills
status: CANDIDATE
---
# Brand Review
...
Review content against your brand voice, style guide, and messaging pillars, flagging deviations by severity

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires brand review capabilities.
