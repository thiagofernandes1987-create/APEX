...
input_schema:
  ...
  triggers:
  - use cowork plugin customizer task
...
synergy_map:
  marketing:
    ...
    call_when: Problema requer tanto apex_internals quanto marketing
    protocol: 1. Esta skill executa sua parte → 2. Skill de marketing complementa → 3. Combinar outputs
    strength: 0.65
  product-management:
    relationship: Conteúdo menciona 2 sinais do domínio product-management
    call_when: Problema requer tanto apex_internals quanto product-management
