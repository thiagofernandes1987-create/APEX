...
version: v00.33.0
status: ADOPTED
domain_path: apex_internals/plugins/create-cowork-plugin
anchors:
- create
- cowork
- plugin
...
Use this skill when the task requires create cowork plugin capabilities.
