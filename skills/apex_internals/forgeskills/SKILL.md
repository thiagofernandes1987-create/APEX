...
description: "Pipeline 4-estágios para leitura rápida e ingestão segura de skills externas de repositórios GitHub. Combina C4-Architecture (discovery) + DocsArchitect (analysis) + ClarityGate (validation) + dynamic_skill_forge (execution)."
version: v00.33.0
status: ADOPTED
