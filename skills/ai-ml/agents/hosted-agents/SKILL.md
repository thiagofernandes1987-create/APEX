---
skill_id: ai_ml.agents.hosted_agents
name: hosted-agents
...
input_schema:
  ...
  triggers:
  - Build background agents in sandboxed environments
...
Build background agents in sandboxed environments. Use for hosted coding agents, sandboxed VMs, Modal sandboxes,
