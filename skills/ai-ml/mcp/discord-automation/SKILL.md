---
skill_id: ai_ml.mcp.discord_automation
name: discord-automation
description: '''Automate Discord tasks via Rube MCP (Composio): messages, channels, roles, webhooks, reactions. Always search
  tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/discord-automation
anchors:
- discord
- automation
- automate
