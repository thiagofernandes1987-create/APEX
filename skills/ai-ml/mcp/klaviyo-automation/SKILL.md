---
skill_id: ai_ml.mcp.klaviyo_automation
name: klaviyo-automation
description: '''Automate Klaviyo tasks via Rube MCP (Composio): manage email/SMS campaigns, inspect campaign messages, track
