---
skill_id: ai_ml.mcp.one_drive_automation
name: one-drive-automation
description: '''Automate OneDrive file management, search, uploads, downloads, sharing, permissions, and folder operations
  via Rube MCP (Composio). Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/one-drive-automation
anchors:
- drive
- automation
- automate
