---
skill_id: ai_ml.mcp.pipedrive_automation
name: pipedrive-automation
description: '''Automate Pipedrive CRM operations including deals, contacts, organizations, activities, notes, and pipeline
  management via Rube MCP (Composio). Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/pipedrive-automation
anchors:
- pipedrive
- automation
- automate
