---
skill_id: ai_ml.mcp.instagram_automation
name: instagram-automation
description: '''Automate Instagram tasks via Rube MCP (Composio): create posts, carousels, manage media, get insights, and
  publishing limits. Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/instagram-automation
anchors:
- instagram
- automation
- automate
