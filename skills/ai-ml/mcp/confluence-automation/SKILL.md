---
skill_id: ai_ml.mcp.confluence_automation
name: confluence-automation
description: '''Automate Confluence page creation, content search, space management, labels, and hierarchy navigation via
  Rube MCP (Composio). Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/confluence-automation
anchors:
- confluence
- automation
- automate
