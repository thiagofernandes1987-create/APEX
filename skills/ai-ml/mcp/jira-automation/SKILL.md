---
skill_id: ai_ml.mcp.jira_automation
name: jira-automation
description: '''Automate Jira tasks via Rube MCP (Composio): issues, projects, sprints, boards, comments, users. Always search
  tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/jira-automation
anchors:
- jira
- automation
- automate
