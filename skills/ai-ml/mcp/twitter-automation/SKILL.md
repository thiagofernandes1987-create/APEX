---
skill_id: ai_ml.mcp.twitter_automation
name: twitter-automation
description: '''Automate Twitter/X tasks via Rube MCP (Composio): posts, search, users, bookmarks, lists, media. Always search
  tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/twitter-automation
anchors:
- twitter
- automation
- automate
