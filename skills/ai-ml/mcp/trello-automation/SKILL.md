---
skill_id: ai_ml.mcp.trello_automation
name: trello-automation
description: '''Automate Trello boards, cards, and workflows via Rube MCP (Composio). Create cards, manage lists, assign members,
