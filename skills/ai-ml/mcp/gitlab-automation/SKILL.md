---
skill_id: ai_ml.mcp.gitlab_automation
name: gitlab-automation
description: '''Automate GitLab project management, issues, merge requests, pipelines, branches, and user operations via Rube
