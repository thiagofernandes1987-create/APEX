---
skill_id: ai_ml.mcp.youtube_automation
name: youtube-automation
description: '''Automate YouTube tasks via Rube MCP (Composio): upload videos, manage playlists, search content, get analytics,
