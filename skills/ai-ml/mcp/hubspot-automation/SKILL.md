---
skill_id: ai_ml.mcp.hubspot_automation
name: hubspot-automation
description: '''Automate HubSpot CRM operations (contacts, companies, deals, tickets, properties) via Rube MCP using Composio
  integration.'''
version: v00.33.0
status: CANDIDATE
