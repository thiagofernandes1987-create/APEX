---
skill_id: ai_ml.mcp.wrike_automation
name: wrike-automation
description: '''Automate Wrike project management via Rube MCP (Composio): create tasks/folders, manage projects, assign work,
  and track progress. Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/wrike-automation
anchors:
- wrike
- automation
- automate
