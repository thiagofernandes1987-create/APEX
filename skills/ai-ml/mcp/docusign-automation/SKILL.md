---
skill_id: ai_ml.mcp.docusign_automation
name: docusign-automation
description: '''Automate DocuSign tasks via Rube MCP (Composio): templates, envelopes, signatures, document management. Always
  search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/docusign-automation
anchors:
- docusign
- automation
- automate
