---
skill_id: ai_ml.mcp.freshservice_automation
name: freshservice-automation
description: '''Automate Freshservice ITSM tasks via Rube MCP (Composio): create/update tickets, bulk operations, service
  requests, and outbound emails. Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/freshservice-automation
anchors:
- freshservice
- automation
- automate
