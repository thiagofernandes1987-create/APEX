---
skill_id: ai_ml.mcp.intercom_automation
name: intercom-automation
description: '''Automate Intercom tasks via Rube MCP (Composio): conversations, contacts, companies, segments, admins. Always
  search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/intercom-automation
anchors:
- intercom
- automation
- automate
