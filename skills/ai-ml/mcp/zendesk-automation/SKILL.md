---
skill_id: ai_ml.mcp.zendesk_automation
name: zendesk-automation
description: '''Automate Zendesk tasks via Rube MCP (Composio): tickets, users, organizations, replies. Always search tools
  first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/zendesk-automation
anchors:
- zendesk
- automation
- automate
