---
skill_id: ai_ml.mcp.pagerduty_automation
name: pagerduty-automation
description: '''Automate PagerDuty tasks via Rube MCP (Composio): manage incidents, services, schedules, escalation policies,
  and on-call rotations. Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/pagerduty-automation
anchors:
- pagerduty
- automation
- automate
