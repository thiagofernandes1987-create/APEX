---
skill_id: ai_ml.mcp.miro_automation
name: miro-automation
description: '''Automate Miro tasks via Rube MCP (Composio): boards, items, sticky notes, frames, sharing, connectors. Always
  search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/miro-automation
anchors:
- miro
- automation
- automate
