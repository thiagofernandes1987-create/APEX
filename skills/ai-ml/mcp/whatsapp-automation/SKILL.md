---
skill_id: ai_ml.mcp.whatsapp_automation
name: whatsapp-automation
description: '''Automate WhatsApp Business tasks via Rube MCP (Composio): send messages, manage templates, upload media, and
  handle contacts. Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/mcp/whatsapp-automation
anchors:
- whatsapp
- automation
- automate
