---
skill_id: ai_ml.mcp.mcp_builder_ms
name: mcp-builder-ms
description: '''Use this skill when building MCP servers to integrate external APIs or services, whether in Python (FastMCP)
