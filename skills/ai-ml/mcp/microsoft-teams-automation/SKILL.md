---
skill_id: ai_ml.mcp.microsoft_teams_automation
name: microsoft-teams-automation
description: '''Automate Microsoft Teams tasks via Rube MCP (Composio): send messages, manage channels, create meetings, handle
