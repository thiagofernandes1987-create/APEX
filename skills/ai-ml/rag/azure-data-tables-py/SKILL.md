---
skill_id: ai_ml.rag.azure_data_tables_py
name: azure-data-tables-py
description: Azure Tables SDK for Python (Storage and Cosmos DB). Use for NoSQL key-value storage, entity CRUD, and batch
  operations.
version: v00.33.0
status: CANDIDATE
