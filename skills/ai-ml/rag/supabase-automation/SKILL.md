---
skill_id: ai_ml.rag.supabase_automation
name: supabase-automation
description: '''Automate Supabase database queries, table management, project administration, storage, edge functions, and
  SQL execution via Rube MCP (Composio). Always search tools first for current schemas.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/rag/supabase-automation
anchors:
- supabase
- automation
- automate
