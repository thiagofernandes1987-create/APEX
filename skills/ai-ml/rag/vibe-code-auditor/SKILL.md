---
skill_id: ai_ml.rag.vibe_code_auditor
...
input_schema:
  ...
  triggers:
  - Audit rapidly generated or AI-produced code for structural flaws
...
output_schema:
  ...
  description: 'Produce the audit report using exactly this structure. Do not omit sections. If a section has no findings,
    write "None identified."


    **Productivity Rules:**

    - Lead with the 3-5 most critical findings '
what_if_fails:
