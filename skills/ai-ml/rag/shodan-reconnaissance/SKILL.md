---
skill_id: ai_ml.rag.shodan_reconnaissance
name: shodan-reconnaissance
description: '''Provide systematic methodologies for leveraging Shodan as a reconnaissance tool during penetration testing
  engagements.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/rag/shodan-reconnaissance
anchors:
- shodan
- reconnaissance
- provide
...
output_schema:
  ...
  description: '- **Asset Inventory**: List of discovered hosts, ports, and services

    - **Vulnerability Report**: Identified CVEs and exposed vulnerable services

    - **Banner Data**: Service banners revealing software v'
what_if_fails:
