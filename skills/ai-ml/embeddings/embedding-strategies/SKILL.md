---
skill_id: ai_ml.embeddings.embedding_strategies
name: embedding-strategies
description: "Apply — "
version: v00.33.0
status: ADOPTED
domain_path: ai-ml/embeddings/embedding-strategies
anchors:
- embedding
- strategies
- guide
...
input_schema:
  ...
  triggers:
  - apply embedding strategies task
...
Use this skill when the task requires embedding strategies capabilities.
