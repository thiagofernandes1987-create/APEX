---
skill_id: ai_ml.llm.llm_app_patterns
name: llm-app-patterns
description: '''Production-ready patterns for building LLM applications, inspired by [Dify](https://github.com/langgenius/dify)
  and industry best practices.'''
version: v00.33.0
status: CANDIDATE
domain_path: ai-ml/llm/llm-app-patterns
anchors:
- patterns
- production
- ready
