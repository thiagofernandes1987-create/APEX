...
name: loki-mode
description: '''Version 2.35.0 | PRD to Production | Zero Human Intervention > Research-enhanced: OpenAI SDK, DeepMind, Anthropic,
...
output_schema:
  ...
  description: '- [ ] Pull request with Why/What/Trade-offs description
