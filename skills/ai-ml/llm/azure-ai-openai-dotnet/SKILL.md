---
skill_id: ai_ml.llm.azure_ai_openai_dotnet
...
Apply — Azure OpenAI SDK for .NET. Client library for Azure OpenAI and OpenAI services. Use for chat completions, embeddings,
