---
skill_id: business_human_resources.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate 21risk tasks via Rube MCP (Composio)
...
Use this skill when the task requires  21risk automation capabilities.
