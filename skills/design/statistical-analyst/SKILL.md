---
skill_id: design.statistical_analyst
...
output_schema:
  ...
  description: '| Request | Deliverable |
    ...
    | "How big should our test be?" | Sample size report with power/MDE tradeo'
what_if_fails:
...
Run hypothesis tests, analyze A/B experiment results, calculate sample sizes, and interpret statistical significance

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires statistical analyst capabilities.
