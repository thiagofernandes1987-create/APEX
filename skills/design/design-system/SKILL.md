...
what_if_fails: >
  FALLBACK: If Ckm:Design System cannot complete, provide partial results with
...
Provides specialized `design-system` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `design-system` tasks in the `design` domain.
