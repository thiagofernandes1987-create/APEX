---
skill_id: design.ux.skills
name: "ux-copy"
description: "Write or review UX copy — microcopy, error messages, empty states, CTAs. Trigger with 'write copy for', 'what should this button say?', 'review this error message', or when naming a CTA, wording a con"
version: v00.33.0
status: ADOPTED
domain_path: design/ux/skills
anchors:
  - copy
  - write
  - review
