...
what_if_fails: >
  FALLBACK: If Ckm:Design cannot complete, provide partial results with
...
Provides specialized `design` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `design` tasks in the `design` domain.
