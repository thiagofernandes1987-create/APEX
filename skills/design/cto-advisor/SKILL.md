...
input_schema:
  ...
  triggers:
  - Technical leadership guidance for engineering teams
...
output_schema:
  ...
  description: '| Request | You Produce |
    ...
    | "Should we build or buy X?" | Build vs buy analy'
what_if_fails:
...
Design — Technical leadership guidance for engineering teams, architecture decisions, and technology strategy. Use when

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires cto advisor capabilities.
