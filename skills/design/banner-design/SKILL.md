...
what_if_fails: >
  FALLBACK: If Ckm:Banner Design cannot complete, provide partial results with
...
Provides specialized `banner-design` capability to the APEX system.

## When to Use
<!-- TODO: describe when to invoke this skill vs alternatives -->
Use this skill when working with `banner-design` tasks in the `design` domain.
