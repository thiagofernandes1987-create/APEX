---
skill_id: design.churn_prevention
...
input_schema:
  ...
  triggers:
  - Reduce voluntary and involuntary churn through cancel flow design
...
output_schema:
  ...
  description: '| When you ask for... | You get... |
    ...
    | "Design a cancel flow" | 5-stage flow diagram (text) with copy for each stage, save offer map, and confirmation email
    template'
what_if_fails:
...
Design — Reduce voluntary and involuntary churn through cancel flow design, save offers, exit surveys, and dunning sequences.
