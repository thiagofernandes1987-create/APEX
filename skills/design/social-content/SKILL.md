---
skill_id: design.social_content
name: social-content
...
output_schema:
  ...
  description: '| When you ask for... | You get... |
    ...
    | A content calendar | Weekly or mo'
what_if_fails:
...
Design — When the user wants help creating, scheduling, or optimizing social media content for LinkedIn, Twitter/X, Instagram,
