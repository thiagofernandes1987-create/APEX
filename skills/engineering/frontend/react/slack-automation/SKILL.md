---
skill_id: engineering.frontend.react.slack_automation
name: slack-automation
description: '''Automate Slack workspace operations including messaging, search, channel management, and reaction workflows
  through Composio''s Slack toolkit.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/frontend/react/slack-automation
anchors:
- slack
- automation
- automate
