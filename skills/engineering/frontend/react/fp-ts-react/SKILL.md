...
name: fp-ts-react
description: '''Practical patterns for using fp-ts with React - hooks, state, forms, data fetching. Use when building React
  apps with functional programming patterns. Works with React 18/19, Next.js 14/15.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/frontend/react/fp-ts-react
anchors:
- react
- practical
- patterns
