---
skill_id: engineering.frontend.react.angular
name: angular
description: "Implement — Modern Angular (v20+) expert with deep knowledge of Signals, Standalone Components, Zoneless applications, SSR/Hydration,"
  and reactive patterns.
version: v00.33.0
status: ADOPTED
domain_path: engineering/frontend/react/angular
anchors:
- angular
- modern
- expert
...
input_schema:
  ...
  triggers:
  - Modern Angular (v20+) expert with deep knowledge of Signals
...
Implement — Modern Angular (v20+) expert with deep knowledge of Signals, Standalone Components, Zoneless applications, SSR/Hydration,
