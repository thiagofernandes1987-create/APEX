---
skill_id: engineering.frontend.react.frontend_ui_dark_ts
name: frontend-ui-dark-ts
description: '''A modern dark-themed React UI system using Tailwind CSS and Framer Motion. Designed for dashboards, admin
