...
description: '''Master AngularJS to Angular migration, including hybrid apps, component conversion, dependency injection changes,
  and routing migration.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/frontend/angular/angular-migration
anchors:
- angular
- migration
- master
