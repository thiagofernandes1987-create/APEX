...
description: '''Master modern Angular state management with Signals, NgRx, and RxJS. Use when setting up global state, managing
  component stores, choosing between state solutions, or migrating from legacy patterns.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/frontend/angular/angular-state-management
anchors:
- angular
- state
- management
