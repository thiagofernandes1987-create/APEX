---
skill_id: engineering.testing.html_injection_testing
name: html-injection-testing
description: '''Identify and exploit HTML injection vulnerabilities that allow attackers to inject malicious HTML content
...
output_schema:
  ...
  description: '1. **Vulnerability Report** - Identified injection points
