---
skill_id: engineering.testing.browser_automation
...
input_schema:
  ...
  triggers:
  - Browser automation powers web testing
...
Implement — Browser automation powers web testing, scraping, and AI agent
