...
name: idor-testing
description: '''Provide systematic methodologies for identifying and exploiting Insecure Direct Object Reference (IDOR) vulnerabilities
  in web applications.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/testing/idor-testing
anchors:
- idor
- testing
- provide
...
output_schema:
  ...
  description: '- **IDOR Vulnerability Report**: Documentation of discovered access control bypasses

    - **Proof of Concept**: Evidence of unauthorized data access across user contexts

    - **Affected Endpoints**: List of'
what_if_fails:
