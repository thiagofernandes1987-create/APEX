...
description: '''Comprehensive k6 load testing skill for API, browser, and scalability testing. Write realistic load scenarios,
  analyze results, and integrate with CI/CD.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/testing/k6-load-testing
anchors:
- load
- testing
- comprehensive
