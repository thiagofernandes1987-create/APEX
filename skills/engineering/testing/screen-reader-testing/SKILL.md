---
skill_id: engineering.testing.screen_reader_testing
...
input_schema:
  ...
  triggers:
  - implement screen reader testing task
...
Use this skill when the task requires screen reader testing capabilities.
