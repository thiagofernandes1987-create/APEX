---
skill_id: engineering.cms.wordpress.wordpress_penetration_testing
...
input_schema:
  ...
  triggers:
  - implement wordpress penetration testing task
...
output_schema:
  ...
  description: '1. **WordPress Enumeration Report** - Version, themes, plugins, users
