...
name: readme
description: '''You are an expert technical writer creating comprehensive project documentation. Your goal is to write a README.md
...
output_schema:
  ...
  description: 'Generate a complete README.md file with:
