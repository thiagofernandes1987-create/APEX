...
input_schema:
  ...
  triggers:
  - Expert C4 Code-level documentation specialist
...
Implement — Expert C4 Code-level documentation specialist. Analyzes code directories to create comprehensive C4 code-level

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires c4 code capabilities.
