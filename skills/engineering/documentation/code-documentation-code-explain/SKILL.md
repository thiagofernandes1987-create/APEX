...
input_schema:
  ...
  triggers:
  - implement code documentation code explain task
...
output_schema:
  ...
  description: '- High-level summary of purpose and flow
...
Use this skill when the task requires code documentation code explain capabilities.
