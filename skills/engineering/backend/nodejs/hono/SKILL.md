...
name: hono
description: '''Build ultra-fast web APIs and full-stack apps with Hono — runs on Cloudflare Workers, Deno, Bun, Node.js,
  and any WinterCG-compatible runtime.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/backend/nodejs/hono
anchors:
- hono
- build
- ultra
