...
name: "documentation"
description: "Write and maintain technical documentation. Trigger with 'write docs for', 'document this', 'create a README', 'write a runbook', 'onboarding guide', or when the user needs help with any form of techn"
version: v00.33.0
status: ADOPTED
domain_path: engineering/software/documentation
anchors:
  - documentation
  - write
  - maintain
