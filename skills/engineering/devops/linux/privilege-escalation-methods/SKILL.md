...
description: '''Provide comprehensive techniques for escalating privileges from a low-privileged user to root/administrator
...
output_schema:
  ...
  description: '- Root or Administrator shell access
