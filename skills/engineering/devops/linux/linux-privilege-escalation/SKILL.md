---
skill_id: engineering.devops.linux.linux_privilege_escalation
name: "linux-privilege-escalation"
description: "'Execute systematic privilege escalation assessments on Linux systems to identify and exploit misconfigurations, vulnerable services, and security weaknesses that allow elevation from low-privilege us"
version: v00.33.0
status: CANDIDATE
domain_path: engineering/devops/linux/linux-privilege-escalation
anchors:
  - linux
  - privilege
  - escalation
