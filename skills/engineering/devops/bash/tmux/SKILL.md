...
name: tmux
description: '''Expert tmux session, window, and pane management for terminal multiplexing, persistent remote workflows, and
  shell scripting automation.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/devops/bash/tmux
anchors:
- tmux
- expert
- session
