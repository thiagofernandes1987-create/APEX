---
skill_id: engineering.devops.deployment.istio_traffic_management
...
input_schema:
  ...
  triggers:
  - implement istio traffic management task
...
Use this skill when the task requires istio traffic management capabilities.
