---
skill_id: engineering.devops.deployment.vercel_deployment
...
input_schema:
  ...
  triggers:
  - Expert knowledge for deploying to Vercel with Next
...
Implement — Expert knowledge for deploying to Vercel with Next.js
