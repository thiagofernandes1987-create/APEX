...
description: '''Master database schema and data migrations across ORMs (Sequelize, TypeORM, Prisma), including rollback strategies
  and zero-downtime deployments.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/devops/deployment/database-migration
anchors:
- database
- migration
- master
