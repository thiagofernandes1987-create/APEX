...
input_schema:
  ...
  triggers:
  - implement deployment validation config validate task
...
Use this skill when the task requires deployment validation config validate capabilities.
