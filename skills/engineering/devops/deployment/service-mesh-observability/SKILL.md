---
skill_id: engineering.devops.deployment.service_mesh_observability
...
input_schema:
  ...
  triggers:
  - implement service mesh observability task
...
Use this skill when the task requires service mesh observability capabilities.
