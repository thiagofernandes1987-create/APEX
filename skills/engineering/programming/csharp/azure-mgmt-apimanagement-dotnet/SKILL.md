---
skill_id: engineering.programming.csharp.azure_mgmt_apimanagement_dotnet
...
input_schema:
  ...
  triggers:
  - Azure Resource Manager SDK for API Management in
...
Implement — Azure Resource Manager SDK for API Management in .NET.
