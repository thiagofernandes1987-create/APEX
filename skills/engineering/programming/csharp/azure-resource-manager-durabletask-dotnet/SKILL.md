---
skill_id: engineering.programming.csharp.azure_resource_manager_durabletask_dotnet
name: azure-resource-manager-durabletask-dotnet
description: "Implement — Azure Resource Manager SDK for Durable Task Scheduler in .NET."
version: v00.33.0
status: CANDIDATE
domain_path: engineering/programming/csharp/azure-resource-manager-durabletask-dotnet
anchors:
- azure
- resource
- manager
...
input_schema:
  ...
  triggers:
  - Azure Resource Manager SDK for Durable Task Scheduler in
...
Implement — Azure Resource Manager SDK for Durable Task Scheduler in .NET.
