---
skill_id: engineering.programming.csharp.azure_resource_manager_redis_dotnet
name: azure-resource-manager-redis-dotnet
description: "Implement — Azure Resource Manager SDK for Redis in .NET."
version: v00.33.0
status: CANDIDATE
domain_path: engineering/programming/csharp/azure-resource-manager-redis-dotnet
anchors:
- azure
- resource
- manager
...
input_schema:
  ...
  triggers:
  - Azure Resource Manager SDK for Redis in
...
Implement — Azure Resource Manager SDK for Redis in .NET.
