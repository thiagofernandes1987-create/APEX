---
skill_id: engineering.programming.csharp.azure_security_keyvault_keys_dotnet
...
Implement — Azure Key Vault Keys SDK for .NET. Client library for managing cryptographic keys in Azure Key Vault and Managed
