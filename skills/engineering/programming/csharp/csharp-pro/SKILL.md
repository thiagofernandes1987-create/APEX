---
skill_id: engineering.programming.csharp.csharp_pro
name: csharp-pro
...
input_schema:
  ...
  triggers:
  - Write modern C# code with advanced features like records
...
output_schema:
  ...
  description: '- Clean C# code with modern language features
...
Use this skill when the task requires csharp pro capabilities.
