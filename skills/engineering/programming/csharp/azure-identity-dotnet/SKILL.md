---
skill_id: engineering.programming.csharp.azure_identity_dotnet
...
Implement — Azure Identity SDK for .NET. Authentication library for Azure SDK clients using Microsoft Entra ID. Use for DefaultAzureCredential,
