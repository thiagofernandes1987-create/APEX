---
skill_id: engineering.programming.csharp.azure_mgmt_fabric_dotnet
name: azure-mgmt-fabric-dotnet
description: "Implement — Azure Resource Manager SDK for Fabric in .NET."
version: v00.33.0
status: CANDIDATE
domain_path: engineering/programming/csharp/azure-mgmt-fabric-dotnet
anchors:
- azure
- mgmt
- fabric
...
input_schema:
  ...
  triggers:
  - Azure Resource Manager SDK for Fabric in
...
Implement — Azure Resource Manager SDK for Fabric in .NET.
