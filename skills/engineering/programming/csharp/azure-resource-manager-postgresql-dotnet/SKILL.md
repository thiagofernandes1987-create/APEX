...
input_schema:
  ...
  triggers:
  - Azure PostgreSQL Flexible Server SDK for
...
Implement — Azure PostgreSQL Flexible Server SDK for .NET. Database management for PostgreSQL Flexible Server deployments.
