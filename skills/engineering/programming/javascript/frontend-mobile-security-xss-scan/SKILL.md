...
input_schema:
  ...
  triggers:
  - implement frontend mobile security xss scan task
...
output_schema:
  ...
  description: '1. **Vulnerability Report**: Detailed findings with severity levels
...
Use this skill when the task requires frontend mobile security xss scan capabilities.
