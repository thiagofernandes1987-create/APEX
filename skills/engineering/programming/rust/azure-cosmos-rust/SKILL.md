---
skill_id: engineering.programming.rust.azure_cosmos_rust
name: azure-cosmos-rust
description: Azure Cosmos DB SDK for Rust (NoSQL API). Use for document CRUD, queries, containers, and globally distributed
  data.
version: v00.33.0
status: CANDIDATE
