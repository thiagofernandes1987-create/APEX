...
version: v00.33.0
status: CANDIDATE
domain_path: engineering/programming/rust/systems-programming-rust-project
anchors:
- systems
- programming
- rust
...
input_schema:
  ...
  triggers:
  - implement systems programming rust project task
...
output_schema:
  ...
  description: '1. **Project Structure**: Complete directory tree with idiomatic Rust organization

    2. **Configuration**: Cargo.toml with dependencies and build settings

    3. **Entry Point**: main.rs or lib.rs with prop'
what_if_fails:
...
Use this skill when the task requires systems programming rust project capabilities.
