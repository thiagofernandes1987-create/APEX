---
skill_id: engineering.programming.ruby.ruby_pro
name: ruby-pro
...
input_schema:
  ...
  triggers:
  - Write idiomatic Ruby code with metaprogramming
...
output_schema:
  ...
  description: '- Idiomatic Ruby code following community conventions
...
Write idiomatic Ruby code with metaprogramming, Rails patterns, and performance optimization. Specializes in

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires ruby pro capabilities.
