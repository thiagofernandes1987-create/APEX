---
skill_id: engineering.programming.python.whatsapp_cloud_api
...
input_schema:
  ...
  triggers:
  - Integracao com WhatsApp Business Cloud API (Meta)
...
Implement — Integracao com WhatsApp Business Cloud API (Meta). Mensagens, templates, webhooks HMAC-SHA256, automacao de atendimento.
