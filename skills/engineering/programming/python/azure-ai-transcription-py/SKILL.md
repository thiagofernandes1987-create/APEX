---
skill_id: engineering.programming.python.azure_ai_transcription_py
name: azure-ai-transcription-py
description: Azure AI Transcription SDK for Python. Use for real-time and batch speech-to-text transcription with timestamps
  and diarization.
version: v00.33.0
status: CANDIDATE
