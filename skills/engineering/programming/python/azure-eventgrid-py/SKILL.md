---
skill_id: engineering.programming.python.azure_eventgrid_py
...
Implement — Azure Event Grid SDK for Python. Use for publishing events, handling CloudEvents, and event-driven architectures.
