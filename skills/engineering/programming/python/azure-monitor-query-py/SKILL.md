---
skill_id: engineering.programming.python.azure_monitor_query_py
...
Implement — Azure Monitor Query SDK for Python. Use for querying Log Analytics workspaces and Azure Monitor metrics.
