...
description: "'You are a Python project architecture expert specializing in scaffolding production-ready Python applications. Generate complete project structures with modern tooling (uv, FastAPI, Django), type hin"
version: v00.33.0
status: CANDIDATE
domain_path: engineering/programming/python/python-development-python-scaffold
anchors:
  - python
  - development
  - scaffold
