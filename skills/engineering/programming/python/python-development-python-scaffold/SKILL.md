...
input_schema:
  ...
  triggers:
  - implement python development python scaffold task
...
output_schema:
  ...
  description: '1. **Project Structure**: Complete directory tree with all necessary files
    ...
    3. **Entry Point**: Main application file (main.py, '
what_if_fails:
...
Use this skill when the task requires python development python scaffold capabilities.
