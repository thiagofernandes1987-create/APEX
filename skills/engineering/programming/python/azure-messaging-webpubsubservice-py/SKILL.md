---
skill_id: engineering.programming.python.azure_messaging_webpubsubservice_py
...
Implement — Azure Web PubSub Service SDK for Python. Use for real-time messaging, WebSocket connections, and pub/sub patterns.
