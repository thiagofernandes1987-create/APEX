...
name: "scanpy"
description: "'Scanpy is a scalable Python toolkit for analyzing single-cell RNA-seq data, built on AnnData. Apply this skill for complete single-cell workflows including quality control, normalization, dimensional"
version: v00.33.0
status: CANDIDATE
