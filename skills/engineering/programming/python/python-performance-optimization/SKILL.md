---
skill_id: engineering.programming.python.python_performance_optimization
...
input_schema:
  ...
  triggers:
  - implement python performance optimization task
...
Use this skill when the task requires python performance optimization capabilities.
