---
skill_id: engineering.programming.python.azure_identity_py
name: azure-identity-py
description: Azure Identity SDK for Python authentication. Use for DefaultAzureCredential, managed identity, service principals,
  and token caching.
version: v00.33.0
status: CANDIDATE
