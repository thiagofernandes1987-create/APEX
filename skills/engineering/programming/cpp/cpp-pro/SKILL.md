---
skill_id: engineering.programming.cpp.cpp_pro
name: cpp-pro
...
input_schema:
  ...
  triggers:
  - Write idiomatic C++ code with modern features
...
output_schema:
  ...
  description: '- Modern C++ code following best practices
...
Write idiomatic C++ code with modern features, RAII, smart pointers, and STL algorithms. Handles templates, move

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires cpp pro capabilities.
