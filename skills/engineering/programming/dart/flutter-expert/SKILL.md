---
skill_id: engineering.programming.dart.flutter_expert
name: flutter-expert
description: "Implement — Master Flutter development with Dart 3, advanced widgets, and multi-platform deployment."
version: v00.33.0
status: ADOPTED
domain_path: engineering/programming/dart/flutter-expert
anchors:
- flutter
- expert
- master
...
Implement — Master Flutter development with Dart 3, advanced widgets, and multi-platform deployment.

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires flutter expert capabilities.
