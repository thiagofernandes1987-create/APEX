---
skill_id: engineering.programming.typescript.azure_cosmos_ts
name: azure-cosmos-ts
description: Azure Cosmos DB JavaScript/TypeScript SDK (@azure/cosmos) for data plane operations. Use for CRUD operations
