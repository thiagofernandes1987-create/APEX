...
input_schema:
  ...
  triggers:
  - implement frontend mobile development component scaffold task
...
Use this skill when the task requires frontend mobile development component scaffold capabilities.
