---
skill_id: engineering.cloud.azure.azure_monitor_query_java
name: azure-monitor-query-java
description: Azure Monitor Query SDK for Java. Execute Kusto queries against Log Analytics workspaces and query metrics from
  Azure resources.
version: v00.33.0
status: CANDIDATE
