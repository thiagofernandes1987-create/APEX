...
description: '''Build production-grade Azure Cosmos DB NoSQL services following clean code, security best practices, and TDD
  principles.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/cloud/azure/azure-cosmos-db-py
anchors:
- azure
- cosmos
- build
