---
skill_id: engineering.cloud.azure.azure_ai_translation_text_py
...
input_schema:
  ...
  triggers:
  - Azure AI Text Translation SDK for real-time text translation
...
Implement — Azure AI Text Translation SDK for real-time text translation, transliteration, language detection, and dictionary
