---
skill_id: engineering.cloud.azure.azure_ai_projects_java
name: azure-ai-projects-java
description: Azure AI Projects SDK for Java. High-level SDK for Azure AI Foundry project management including connections,
