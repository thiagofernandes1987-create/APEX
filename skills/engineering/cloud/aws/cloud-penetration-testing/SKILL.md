---
skill_id: engineering.cloud.aws.cloud_penetration_testing
name: cloud-penetration-testing
description: '''Conduct comprehensive security assessments of cloud infrastructure across Microsoft Azure, Amazon Web Services
  (AWS), and Google Cloud Platform (GCP).'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/cloud/aws/cloud-penetration-testing
anchors:
- cloud
- penetration
- testing
...
output_schema:
  ...
  description: '1. **Cloud Security Assessment Report** - Comprehensive findings and risk ratings

    2. **Resource Inventory** - Enumerated services, storage, and compute instances

    3. **Credential Findings** - Exposed s'
what_if_fails:
