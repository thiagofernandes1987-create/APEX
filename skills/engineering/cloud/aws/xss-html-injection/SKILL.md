...
description: '''Execute comprehensive client-side injection vulnerability assessments on web applications to identify XSS
...
output_schema:
  ...
  description: '- XSS/HTMLi vulnerability report with severity classifications
