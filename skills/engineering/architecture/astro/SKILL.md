...
name: astro
description: '''Build content-focused websites with Astro — zero JS by default, islands architecture, multi-framework components,
  and Markdown/MDX support.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/architecture/astro
anchors:
- astro
- build
- content
