...
description: '''Use when performing code review, writing or refactoring code, or discussing architecture; complements clean-code
  and does not replace project linter/formatter.'''
version: v00.33.0
status: CANDIDATE
domain_path: engineering/architecture/uncle-bob-craft
anchors:
- uncle
- craft
- performing
