---
skill_id: ai_ml_agents.composio_skills
...
input_schema:
  ...
  triggers:
  - Automate Agent Mail tasks via Rube MCP (Composio)
...
Use this skill when the task requires agent mail automation capabilities.
