...
input_schema:
  ...
  triggers:
  - Financial analyst agent skill and plugin for Claude Code
...
Use — Financial analyst agent skill and plugin for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Ratio analysis,
