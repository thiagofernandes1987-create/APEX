---
skill_id: ai_ml_agents.agent_designer
name: agent-designer
...
input_schema:
  ...
  triggers:
  - the user asks to design multi-agent systems
...
output_schema:
  ...
  description: '- **Content Moderation:** Harmful content removal, quality checks
...
Use this skill when the user asks to design multi-agent systems, create agent architectures, define agent communication
