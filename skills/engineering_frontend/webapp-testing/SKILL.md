---
skill_id: engineering_frontend.webapp_testing
name: webapp-testing
...
Use — Toolkit for interacting with and testing local web applications using Playwright. Supports verifying frontend
