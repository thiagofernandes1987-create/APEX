...
description: "Create — Research competitors and generate a positioning and messaging comparison with content gaps, opportunities, and"
  threats. Use when building sales battlecards, when finding positioning gaps and messaging
version: v00.33.0
status: ADOPTED
domain_path: marketing/competitive-brief
anchors:
- competitive
- brief
- research
...
output_schema:
  ...
  description: 'Present the full competitive brief with clear formatting. Note the date of the research so the user knows
...
Create — Research competitors and generate a positioning and messaging comparison with content gaps, opportunities, and
