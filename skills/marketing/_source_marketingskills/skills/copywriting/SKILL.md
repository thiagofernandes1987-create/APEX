...
description: "Create — When the user wants to write, rewrite, or improve marketing copy for any page — including homepage, landing pages,"
  ...
  Use this whenever someone is working on website text that needs to persuade or convert. For email copy, see email-sequence.
  For popup copy, see popup-cro. For editing existing copy, see copy-editing.
metadata:
  version: 1.1.0
tier: ADAPTED
anchors:
...
output_schema:
  ...
  description: 'When writing copy, provide:'
what_if_fails:
...
skill_id: marketing._source_marketingskills.skills.copywriting
status: CANDIDATE
---
# Copywriting
