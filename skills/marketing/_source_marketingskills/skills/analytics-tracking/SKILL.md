...
description: When the user wants to set up, improve, or audit analytics tracking and measurement. Also use when the user mentions
  ...
  is working or wants to measure marketing results. For A/B test measurement, see ab-test-setup.
metadata:
  version: 1.1.0
tier: ADAPTED
anchors:
...
skill_id: marketing._source_marketingskills.skills.analytics-tracking
status: CANDIDATE
---
# Analytics Tracking
