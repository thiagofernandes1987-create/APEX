...
description: "Create — When the user wants to create sales collateral, pitch decks, one-pagers, objection handling docs, or demo scripts."
  ...
  close deals. For competitor comparison pages and battle cards, see competitor-alternatives. For marketing website copy,
  see copywriting. For cold outreach emails, see cold-email.
metadata:
  version: 1.1.0
tier: ADAPTED
anchors:
...
output_schema:
  ...
  description: 'Deliver the right format for each asset type:
...
skill_id: marketing._source_marketingskills.skills.sales-enablement
status: ADOPTED
---
# Sales Enablement
