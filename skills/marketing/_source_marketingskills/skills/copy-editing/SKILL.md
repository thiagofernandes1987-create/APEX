...
description: When the user wants to edit, review, or improve existing marketing copy, or refresh outdated content. Also use
  ...
  and wants it improved or refreshed rather than rewritten from scratch. For writing new copy, see copywriting.
metadata:
  version: 1.3.0
tier: ADAPTED
anchors:
...
skill_id: marketing._source_marketingskills.skills.copy-editing
status: CANDIDATE
---
# Copy Editing
