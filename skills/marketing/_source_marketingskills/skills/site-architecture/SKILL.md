...
description: "Create — When the user wants to plan, map, or restructure their website's page hierarchy, navigation, URL structure, or"
  ...
  what pages a website should have and how they connect. NOT for XML sitemaps (that's technical SEO — see seo-audit). For
...
output_schema:
  ...
  description: 'When creating a site architecture plan, provide these deliverables:'
what_if_fails:
...
skill_id: marketing._source_marketingskills.skills.site-architecture
status: ADOPTED
---
# Site Architecture
