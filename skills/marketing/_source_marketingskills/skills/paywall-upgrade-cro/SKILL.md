...
description: "Create — When the user wants to create or optimize in-app paywalls, upgrade screens, upsell modals, or feature gates."
  ...
  where you're asking users to upgrade. Distinct from public pricing pages (see page-cro) — this focuses on in-product upgrade
  moments where the user has already experienced value. For pricing decisions, see pricing-strategy.
metadata:
  version: 1.1.0
tier: ADAPTED
anchors:
...
skill_id: marketing._source_marketingskills.skills.paywall-upgrade-cro
status: CANDIDATE
---
