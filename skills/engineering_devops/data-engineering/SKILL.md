---
skill_id: engineering_devops.data_engineering
...
input_schema:
  ...
  triggers:
  - Data engineering patterns for ETL pipelines
...
Use this skill when the task requires data engineering capabilities.
