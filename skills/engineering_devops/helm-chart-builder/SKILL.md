...
input_schema:
  ...
  triggers:
  - Helm chart development agent skill and plugin for Claude Code
...
Use — Helm chart development agent skill and plugin for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw — chart scaffolding,
