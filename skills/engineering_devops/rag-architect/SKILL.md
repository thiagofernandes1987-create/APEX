---
skill_id: engineering_devops.rag_architect
name: rag-architect
...
input_schema:
  ...
  triggers:
  - the user asks to design RAG pipelines
...
Use this skill when the user asks to design RAG pipelines, optimize retrieval strategies, choose embedding models, implement
