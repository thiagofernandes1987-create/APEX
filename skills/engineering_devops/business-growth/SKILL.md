...
input_schema:
  ...
  triggers:
  - 4 business growth agent skills and plugins for Claude Code
...
Use — 4 business growth agent skills and plugins for Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. Customer success
