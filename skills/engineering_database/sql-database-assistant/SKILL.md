---
skill_id: engineering_database.sql_database_assistant
name: sql-database-assistant
description: Use when the user asks to write SQL queries, optimize database performance, generate migrations, explore database
