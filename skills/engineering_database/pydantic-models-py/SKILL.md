---
skill_id: engineering_database.pydantic_models_py
...
input_schema:
  ...
  triggers:
  - 'Create Pydantic models following the multi-model pattern with Base
...
Use this skill when the task requires pydantic models py capabilities.
