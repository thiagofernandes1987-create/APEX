...
input_schema:
  ...
  triggers:
  - Modern frontend patterns for React Server Components
...
Use — Modern frontend patterns for React Server Components, performance optimization, and Core Web Vitals

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires frontend excellence capabilities.
