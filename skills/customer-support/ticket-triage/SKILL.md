...
name: "ticket-triage"
description: "Triage and prioritize a support ticket or customer issue. Use when a new ticket comes in and needs categorization, assigning P1-P4 priority, deciding which team should handle it, or checking whether i"
version: v00.33.0
status: ADOPTED
domain_path: customer-support/ticket-triage
anchors:
  - ticket
  - triage
  - prioritize
