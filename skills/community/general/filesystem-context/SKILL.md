---
skill_id: community.general.filesystem_context
...
input_schema:
  ...
  triggers:
  - Use for file-based context management
...
Use — Use for file-based context management, dynamic context discovery, and reducing context window bloat. Offload
