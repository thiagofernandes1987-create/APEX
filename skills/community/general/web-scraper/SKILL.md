---
skill_id: community.general.web_scraper
name: web-scraper
...
input_schema:
  ...
  triggers:
  - Web scraping inteligente multi-estrategia
...
Use — Web scraping inteligente multi-estrategia. Extrai dados estruturados de paginas web (tabelas, listas, precos).
