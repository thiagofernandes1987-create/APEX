---
skill_id: community.general.risk_manager
name: risk-manager
...
output_schema:
  ...
  description: '- Risk assessment report with metrics
...
Monitor portfolio risk, R-multiples, and position limits. Creates hedging strategies, calculates expectancy,

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires risk manager capabilities.
