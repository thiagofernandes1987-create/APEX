...
name: last30days
description: '''Research a topic from the last 30 days on Reddit + X + Web, become an expert, and write copy-paste-ready prompts
...
output_schema:
  ...
  description: '```
    ...
    [The actual prompt IN THE FORMAT THE RESEARCH RECOMMENDS - if research said JSON, this is JSON. If research said natural
    language, this is prose. Match '
what_if_fails:
