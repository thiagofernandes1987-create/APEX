---
skill_id: community.general.elixir_pro
name: elixir-pro
...
input_schema:
  ...
  triggers:
  - Write idiomatic Elixir code with OTP patterns
...
output_schema:
  ...
  description: '- Idiomatic Elixir following community style guide

    - OTP applications with proper supervision trees

    - Phoenix apps with contexts and clean boundaries

    - ExUnit tests with doctests and async where possi'
what_if_fails:
...
Write idiomatic Elixir code with OTP patterns, supervision trees, and Phoenix LiveView. Masters concurrency,

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires elixir pro capabilities.
