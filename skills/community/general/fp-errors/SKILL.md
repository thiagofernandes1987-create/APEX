---
skill_id: community.general.fp_errors
name: fp-errors
...
input_schema:
  ...
  triggers:
  - Stop throwing everywhere - handle errors as values using Either and TaskEither for cleaner
...
Use — Stop throwing everywhere - handle errors as values using Either and TaskEither for cleaner, more predictable
