...
description: '''Scrapes content based on a preset URL list, filters high-quality technical information, and generates daily
  Markdown reports.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/daily-news-report
anchors:
- daily
- news
- report
...
output_schema:
  ...
  description: '```markdown
    ...
    > **Warning**: Sub-agent ''worker'' not detected'
what_if_fails:
