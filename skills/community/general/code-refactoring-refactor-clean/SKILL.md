...
input_schema:
  ...
  triggers:
  - use code refactoring refactor clean task
...
output_schema:
  ...
  description: '- Summary of issues and target areas
...
Use this skill when the task requires code refactoring refactor clean capabilities.
