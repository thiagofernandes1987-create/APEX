...
input_schema:
  ...
  triggers:
  - use codebase cleanup tech debt task
...
output_schema:
  ...
  description: '1. **Debt Inventory**: Comprehensive list categorized by type with metrics

    2. **Impact Analysis**: Cost calculations and risk assessments

    3. **Prioritized Roadmap**: Quarter-by-quarter plan with clear'
what_if_fails:
...
Use this skill when the task requires codebase cleanup tech debt capabilities.
