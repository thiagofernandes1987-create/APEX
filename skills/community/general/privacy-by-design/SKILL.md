...
description: '''Use when building apps that collect user data. Ensures privacy protections are built in from the start—data
  minimization, consent, encryption.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/privacy-by-design
anchors:
- privacy
- design
- building
