---
skill_id: community.general.conductor_validator
name: conductor-validator
description: "Use — "
version: v00.33.0
status: ADOPTED
domain_path: community/general/conductor-validator
anchors:
- conductor
- validator
- validates
...
Use this skill when the task requires conductor validator capabilities.
