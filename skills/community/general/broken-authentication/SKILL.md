...
description: '''Identify and exploit authentication and session management vulnerabilities in web applications. Broken authentication
...
output_schema:
  ...
  description: '1. **Authentication Assessment Report** - Document all identified vulnerabilities

    2. **Credential Testing Results** - Brute-force and dictionary attack outcomes

    3. **Session Security Analysis** - Toke'
what_if_fails:
...
synergy_map:
  engineering:
    ...
    strength: 0.7
  security:
    relationship: Conteúdo menciona 5 sinais do domínio security
