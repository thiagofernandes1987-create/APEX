---
skill_id: community.general.incident_response_incident_response
name: incident-response-incident-response
description: "Use — "
version: v00.33.0
status: ADOPTED
domain_path: community/general/incident-response-incident-response
anchors:
- incident
- response
- working
...
input_schema:
  ...
  triggers:
  - use incident response incident response task
...
Use this skill when the task requires incident response incident response capabilities.
