---
skill_id: community.general.project_skill_audit
...
output_schema:
  ...
  description: "Return a compact audit with:\n\n1. `Existing skills`\n   List the project-local skills found and the main\
    \ workflow each one covers.\n\n2. `Suggested updates`\n   For each update candidate, include:\n   - ski"
what_if_fails:
