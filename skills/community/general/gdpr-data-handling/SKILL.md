---
skill_id: community.general.gdpr_data_handling
name: gdpr-data-handling
description: "Use — "
version: v00.33.0
status: CANDIDATE
domain_path: community/general/gdpr-data-handling
anchors:
- gdpr
- data
- handling
...
Use this skill when the task requires gdpr data handling capabilities.
