---
skill_id: community.general.conductor_revert
name: conductor-revert
description: "Use — "
version: v00.33.0
status: ADOPTED
domain_path: community/general/conductor-revert
anchors:
- conductor
- revert
- aware
...
Use this skill when the task requires conductor revert capabilities.
