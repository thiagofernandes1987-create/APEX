---
skill_id: community.general.design_md
name: design-md
description: "Use — "
version: v00.33.0
status: ADOPTED
domain_path: community/general/design-md
anchors:
- design
- analyze
- stitch
...
output_schema:
  ...
  description: '- **Language:** Use descriptive design terminology and natural language exclusively

    - **Format:** Generate a clean Markdown file following the structure below

    - **Precision:** Include exact hex codes '
what_if_fails:
