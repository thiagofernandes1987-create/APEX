...
input_schema:
  ...
  triggers:
  - use error diagnostics smart debug task
...
output_schema:
  ...
  description: 'Provide structured report:
...
Use this skill when the task requires error diagnostics smart debug capabilities.
