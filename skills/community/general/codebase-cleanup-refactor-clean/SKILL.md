...
input_schema:
  ...
  triggers:
  - use codebase cleanup refactor clean task
...
output_schema:
  ...
  description: '- Cleanup plan with prioritized steps
...
Use this skill when the task requires codebase cleanup refactor clean capabilities.
