...
name: pydantic-ai
description: '''Build production-ready AI agents with PydanticAI — type-safe tool use, structured outputs, dependency injection,
  and multi-model support.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/pydantic-ai
anchors:
- pydantic
- build
- production
