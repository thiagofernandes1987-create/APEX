---
skill_id: community.general.stitch_ui_design
name: "stitch-ui-design"
description: "'Expert guidance for crafting effective prompts in Google Stitch, the AI-powered UI design tool by Google Labs. This skill helps create precise, actionable prompts that generate high-quality UI design"
version: v00.33.0
status: CANDIDATE
domain_path: community/general/stitch-ui-design
anchors:
  - stitch
  - design
  - expert
