...
description: '''Optimize website and web application performance including loading speed, Core Web Vitals, bundle size, caching
  strategies, and runtime performance'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/web-performance-optimization
anchors:
- performance
- optimization
- optimize
