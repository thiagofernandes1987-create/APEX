...
description: '''Identify and exploit file path traversal (directory traversal) vulnerabilities that allow attackers to read
...
output_schema:
  ...
  description: '1. **Vulnerability Report** - Identified traversal points and severity
