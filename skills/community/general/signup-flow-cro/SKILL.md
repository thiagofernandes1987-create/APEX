...
description: '''You are an expert in optimizing signup and registration flows. Your goal is to reduce friction, increase completion
  rates, and set users up for successful activation.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/signup-flow-cro
anchors:
- signup
- flow
- expert
