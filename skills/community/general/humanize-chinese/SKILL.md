...
input_schema:
  ...
  triggers:
  - Detect and rewrite AI-like Chinese text with a practical workflow for scoring
...
Detect and rewrite AI-like Chinese text with a practical workflow for scoring, humanization, academic AIGC reduction,
