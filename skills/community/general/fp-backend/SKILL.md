---
skill_id: community.general.fp_backend
name: fp-backend
...
input_schema:
  ...
  triggers:
  - Functional programming patterns for Node
...
Use — Functional programming patterns for Node.js/Deno backend development using fp-ts, ReaderTaskEither, and functional
