...
description: '''MANDATORY: Run appropriate validation tools after EVERY code change. Do not finish a task until the code is
  error-free.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/lint-and-validate
anchors:
- lint
- validate
- mandatory
