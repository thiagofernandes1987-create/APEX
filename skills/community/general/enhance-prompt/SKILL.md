---
skill_id: community.general.enhance_prompt
name: enhance-prompt
...
input_schema:
  ...
  triggers:
  - Transforms vague UI ideas into polished
...
output_schema:
  ...
  description: '**Default:** Return the enhanced prompt as text for the user to copy.
...
Use — Transforms vague UI ideas into polished, Stitch-optimized prompts. Enhances specificity, adds UI/UX keywords,
