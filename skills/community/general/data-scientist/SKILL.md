---
skill_id: community.general.data_scientist
name: data-scientist
...
input_schema:
  ...
  triggers:
  - Expert data scientist for advanced analytics
...
Use — Expert data scientist for advanced analytics, machine learning, and statistical modeling. Handles complex data

<!-- SR_40: auto-generated from frontmatter `purpose`/`description` (OPP-Phase3). Expand with domain-specific rationale. -->

## When to Use

Use this skill when the task requires data scientist capabilities.
