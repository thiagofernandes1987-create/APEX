...
name: multi-advisor
description: '''Conselho de especialistas — consulta multiplos agentes do ecossistema em paralelo para analise multi-perspectiva
  de qualquer topico. Ativa personas, especialistas e agentes tecnicos simultaneamente, '
version: v00.33.0
status: CANDIDATE
domain_path: community/general/multi-advisor
anchors:
- multi
- advisor
- conselho
...
synergy_map:
  legal:
    relationship: Conteúdo menciona 4 sinais do domínio legal
