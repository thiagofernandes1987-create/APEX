---
skill_id: community.general.legacy_modernizer
...
output_schema:
  ...
  description: '- Migration plan with phases and milestones
...
Use this skill when the task requires legacy modernizer capabilities.
