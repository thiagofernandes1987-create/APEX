---
skill_id: community.general.videodb
name: videodb
...
Use — Video and audio perception, indexing, and editing. Ingest files/URLs/live streams, build visual/spoken indexes,
