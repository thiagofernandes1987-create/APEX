...
description: '''Give agents persistent structural memory of a codebase — navigate dependencies, track public APIs, and understand
  why connections exist without re-reading the whole repo.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/data-structure-protocol
anchors:
- data
- structure
- protocol
