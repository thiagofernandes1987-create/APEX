---
skill_id: community.general.performance_optimizer
name: performance-optimizer
description: '''Identifies and fixes performance bottlenecks in code, databases, and APIs. Measures before and after to prove
  improvements.'''
version: v00.33.0
status: CANDIDATE
domain_path: community/general/performance-optimizer
anchors:
- performance
- optimizer
- identifies
