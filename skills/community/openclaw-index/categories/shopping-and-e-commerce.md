...
- [filewave](https://clawskills.sh/skills/jlevitsk-filewave) - Query and manage FileWave UEM device inventory via REST API.
- [food-order](https://clawskills.sh/skills/steipete-food-order) - Reorder Foodora orders + track ETA/status with ordercli.
- [gousto](https://clawskills.sh/skills/dhruvkelawala-gousto) - Search and browse 9,000+ Gousto recipes.
- [gurkerlcli](https://clawskills.sh/skills/pasogott-gurkerlcli) - Austrian online grocery shopping via gurkerl.at.
- [idealista](https://clawskills.sh/skills/quifago-idealista) - Query Idealista API via idealista-cli (OAuth2 client credentials).
- [irish-takeaway](https://clawskills.sh/skills/cotyledonlab-irish-takeaway) - Find nearby takeaways in Ireland and browse menus.
- [jellyseerr](https://clawskills.sh/skills/ericrosenberg-jellyseerr) - Request movies and TV shows through Jellyseerr.
- [jlm-coffee](https://clawskills.sh/skills/alexpolonsky-jlm-coffee) - Search specialty coffee shops in Jerusalem by amenities and hours.
