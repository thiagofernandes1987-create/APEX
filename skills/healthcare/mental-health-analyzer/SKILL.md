---
skill_id: healthcare.mental_health_analyzer
name: mental-health-analyzer
description: "Analyze — 分析心理健康数据、识别心理模式、评估心理健康状况、提供个性化心理健康建议。支持与睡眠、运动、营养等其他健康数据的关联分析。"
version: v00.33.0
status: ADOPTED
domain_path: healthcare/mental-health-analyzer
anchors:
- mental
- health
- analyzer
...
Analyze — 分析心理健康数据、识别心理模式、评估心理健康状况、提供个性化心理健康建议。支持与睡眠、运动、营养等其他健康数据的关联分析。
