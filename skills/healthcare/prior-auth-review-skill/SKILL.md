...
description: Automate payer review of prior authorization (PA) requests. This skill should be used when users say 'Review
  this PA request', 'Process prior authorization for [procedure]', 'Assess medical necessity'
version: v00.33.0
status: ADOPTED
domain_path: healthcare/prior-auth-review-skill
anchors:
- prior
- auth
- review
...
## Diff History
- **v00.33.0**: Ingested from healthcare-main — auto-converted to APEX format
