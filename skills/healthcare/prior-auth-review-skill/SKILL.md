...
description: "Automate payer review of prior authorization (PA) requests. This skill should be used when users say 'Review this PA request', 'Process prior authorization for [procedure]', 'Assess medical necessity'"
version: v00.33.0
status: ADOPTED
