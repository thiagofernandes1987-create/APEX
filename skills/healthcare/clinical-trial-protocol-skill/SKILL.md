...
description: "Generate clinical trial protocols for medical devices or drugs. This skill should be used when users say 'Create a clinical trial protocol', 'Generate protocol for [device/drug]', 'Help me design a cl"
version: v00.33.0
status: ADOPTED
domain_path: healthcare/clinical-trial-protocol-skill
anchors:
  - clinical
  - trial
  - protocol
