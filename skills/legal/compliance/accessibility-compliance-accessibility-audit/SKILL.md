...
input_schema:
  ...
  triggers:
  - review accessibility compliance accessibility audit task
...
Use this skill when the task requires accessibility compliance accessibility audit capabilities.
