...
description: "Prepare structured briefings for meetings with legal relevance and track resulting action items. Use when preparing for contract negotiations, board meetings, compliance reviews, or any meeting where "
version: v00.33.0
status: ADOPTED
domain_path: legal/knowledge-work/meeting-briefing
anchors:
  - meeting
  - briefing
  - prepare
