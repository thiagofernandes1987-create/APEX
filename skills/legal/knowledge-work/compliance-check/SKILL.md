...
description: "Run a compliance check on a proposed action, product feature, or business initiative, surfacing applicable regulations, required approvals, and risk areas. Use when launching a feature that touches pe"
version: v00.33.0
status: ADOPTED
domain_path: legal/knowledge-work/compliance-check
anchors:
  - compliance
  - check
  - proposed
